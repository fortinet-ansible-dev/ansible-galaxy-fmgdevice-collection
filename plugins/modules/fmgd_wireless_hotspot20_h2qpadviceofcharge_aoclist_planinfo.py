...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_h2qpadviceofcharge_aoclist_planinfo
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Plan info.
      fortinet.fmgdevice.fmgd_wireless_hotspot20_h2qpadviceofcharge_aoclist_planinfo:
...
def main():
    urls_list = [
        '/pm/config/device/{device}/vdom/{vdom}/wireless-controller/hotspot20/h2qp-advice-of-charge/{h2qp-advice-of-charge}/aoc-list/{aoc-list}/plan-info'
    ]
    url_params = ['device', 'vdom', 'h2qp-advice-of-charge', 'aoc-list']
    ...
    module_arg_spec = {
        ...
        'wireless_hotspot20_h2qpadviceofcharge_aoclist_planinfo': {
            ...
            'options': {
                'currency': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'info-file': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'lang': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_h2qpadviceofcharge_aoclist_planinfo'),
