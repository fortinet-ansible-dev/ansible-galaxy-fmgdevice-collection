...
DOCUMENTATION = '''
---
module: fmgd_system_dhcp6_server_options
short_description: DHCPv6 options.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_dhcp6_server_options'),
