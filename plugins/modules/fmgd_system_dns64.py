...
DOCUMENTATION = '''
---
module: fmgd_system_dns64
short_description: Configure DNS64.
description:
        ...
        suboptions:
            always_synthesize_aaaa_record:
                ...
                choices:
                    ...
                    - 'enable'
            dns64_prefix:
                aliases: ['dns64-prefix']
                type: str
                description: DNS64 prefix must be
            status:
                type: str
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure DNS64.
      fortinet.fmgdevice.fmgd_system_dns64:
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_dns64': {
            ...
            'options': {
                ...
                'dns64-prefix': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_dns64'),
