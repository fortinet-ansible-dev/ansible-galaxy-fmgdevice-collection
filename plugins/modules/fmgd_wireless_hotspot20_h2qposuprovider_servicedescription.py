...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_h2qposuprovider_servicedescription
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: OSU service name.
      fortinet.fmgdevice.fmgd_wireless_hotspot20_h2qposuprovider_servicedescription:
...
def main():
    ...
    url_params = ['device', 'vdom', 'h2qp-osu-provider']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_h2qposuprovider_servicedescription'),
