...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_switchgroup
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure FortiSwitch switch groups.
      fortinet.fmgdevice.fmgd_switchcontroller_switchgroup:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_switchgroup'),
