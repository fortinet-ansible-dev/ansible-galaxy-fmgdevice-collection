...
DOCUMENTATION = '''
---
module: fmgd_router_bgp_neighborrange
short_description: BGP neighbor range table.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: BGP neighbor range table.
      fortinet.fmgdevice.fmgd_router_bgp_neighborrange:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_bgp_neighborrange'),
