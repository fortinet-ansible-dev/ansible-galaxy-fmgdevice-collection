...
DOCUMENTATION = '''
---
module: fmgd_router_ripng_network
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Network.
      fortinet.fmgdevice.fmgd_router_ripng_network:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_ripng_network'),
