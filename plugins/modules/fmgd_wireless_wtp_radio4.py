...
DOCUMENTATION = '''
---
module: fmgd_wireless_wtp_radio4
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configuration options for radio 4.
      fortinet.fmgdevice.fmgd_wireless_wtp_radio4:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_wtp_radio4'),
