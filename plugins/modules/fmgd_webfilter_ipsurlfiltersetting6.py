...
DOCUMENTATION = '''
---
module: fmgd_webfilter_ipsurlfiltersetting6
    ...
    webfilter_ipsurlfiltersetting6:
        ...
        suboptions:
            ...
            geo_filter:
                aliases: ['geo-filter']
                type: str
                description: Filter based on geographical location.
'''
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure IPS URL filter settings for IPv6.
      fortinet.fmgdevice.fmgd_webfilter_ipsurlfiltersetting6:
...
def main():
    ...
    module_arg_spec = {
        ...
        'webfilter_ipsurlfiltersetting6': {
            ...
            'options': {
                ...
                'geo-filter': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'webfilter_ipsurlfiltersetting6'),
