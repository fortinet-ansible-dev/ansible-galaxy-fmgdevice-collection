...
DOCUMENTATION = '''
---
module: fmgd_system_speedtestserver_host
short_description: Hosts of the server.
description:
...
options:
    ...
    vdom:
        ...
        required: true
    speed-test-server:
        description: Deprecated, please use "speed_test_server"
        type: str
    speed_test_server:
        description: The parameter (speed-test-server) in requested url.
        type: str
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Hosts of the server.
      fortinet.fmgdevice.fmgd_system_speedtestserver_host:
        ...
        vdom: <your own value>
        speed_test_server: <your own value>
...
def main():
    ...
    url_params = ['device', 'vdom', 'speed-test-server']
    module_primary_key = 'id'
    module_arg_spec = {
        'device': {'required': True, 'type': 'str'},
        'vdom': {'required': True, 'type': 'str'},
        'speed-test-server': {'type': 'str', 'api_name': 'speed_test_server'},
        'speed_test_server': {'type': 'str'},
        'system_speedtestserver_host': {
            'type': 'dict',
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_speedtestserver_host'),
