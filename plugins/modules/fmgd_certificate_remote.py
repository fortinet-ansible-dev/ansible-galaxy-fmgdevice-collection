...
DOCUMENTATION = '''
---
module: fmgd_certificate_remote
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Remote certificate as a PEM file.
      fortinet.fmgdevice.fmgd_certificate_remote:
...
def main():
    ...
    module_arg_spec = {
        ...
        'certificate_remote': {
            ...
            'options': {
                ...
                'range': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['vdom', 'global'], 'type': 'str'},
                'remote': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'certificate_remote'),
