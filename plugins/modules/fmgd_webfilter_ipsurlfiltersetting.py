...
DOCUMENTATION = '''
---
module: fmgd_webfilter_ipsurlfiltersetting
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure IPS URL filter settings.
      fortinet.fmgdevice.fmgd_webfilter_ipsurlfiltersetting:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'webfilter_ipsurlfiltersetting'),
