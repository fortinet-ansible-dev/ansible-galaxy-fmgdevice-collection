...
DOCUMENTATION = '''
---
module: fmgd_vpnsslweb_userbookmark
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure SSL-VPN user bookmark.
      fortinet.fmgdevice.fmgd_vpnsslweb_userbookmark:
...
def main():
    ...
    module_arg_spec = {
        ...
        'vpnsslweb_userbookmark': {
            ...
            'options': {
                ...
                'custom-lang': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'vpnsslweb_userbookmark'),
