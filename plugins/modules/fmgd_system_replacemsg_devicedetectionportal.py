...
DOCUMENTATION = '''
---
module: fmgd_system_replacemsg_devicedetectionportal
short_description: Device system replacemsg device detection portal
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Device system replacemsg device detection portal
      fortinet.fmgdevice.fmgd_system_replacemsg_devicedetectionportal:
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_replacemsg_devicedetectionportal': {
            ...
            'options': {
                'buffer': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_replacemsg_devicedetectionportal'),
