...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_h2qposuprovider_friendlyname
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: OSU provider friendly name.
      fortinet.fmgdevice.fmgd_wireless_hotspot20_h2qposuprovider_friendlyname:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_h2qposuprovider_friendlyname'),
