...
DOCUMENTATION = '''
---
module: fmgd_azure_vwanslb_permanentsecurityrules
short_description: Configure permanent security rules.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure permanent security rules.
      fortinet.fmgdevice.fmgd_azure_vwanslb_permanentsecurityrules:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'azure_vwanslb_permanentsecurityrules'),
