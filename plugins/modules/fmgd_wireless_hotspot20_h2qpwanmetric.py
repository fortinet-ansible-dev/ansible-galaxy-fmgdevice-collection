...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_h2qpwanmetric
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure WAN metrics.
      fortinet.fmgdevice.fmgd_wireless_hotspot20_h2qpwanmetric:
...
def main():
    ...
    module_arg_spec = {
        ...
        'wireless_hotspot20_h2qpwanmetric': {
            ...
            'options': {
                'downlink-load': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'downlink-speed': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'link-at-capacity': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'link-status': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['down', 'up', 'in-test'], 'type': 'str'},
                'load-measurement-duration': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'name': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'required': True, 'type': 'str'},
                'symmetric-wan-link': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['asymmetric', 'symmetric'], 'type': 'str'},
                'uplink-load': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'uplink-speed': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_h2qpwanmetric'),
