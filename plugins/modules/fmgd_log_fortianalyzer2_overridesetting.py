...
DOCUMENTATION = '''
---
module: fmgd_log_fortianalyzer2_overridesetting
...
options:
    ...
    log_fortianalyzer2_overridesetting:
        ...
        suboptions:
            ...
            override:
                type: str
                description: Enable/disable overriding FortiAnalyzer settings or use global settings.
                choices:
                    - 'disable'
                    - 'enable'
            vrf_select:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Override FortiAnalyzer settings.
      fortinet.fmgdevice.fmgd_log_fortianalyzer2_overridesetting:
...
def main():
    ...
    module_arg_spec = {
        ...
        'log_fortianalyzer2_overridesetting': {
            ...
            'options': {
                ...
                'enc-algorithm': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['high', 'low', 'high-medium', 'low-medium'], 'type': 'str'},
                ...
                'use-management-vdom': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'log_fortianalyzer2_overridesetting'),
