...
DOCUMENTATION = '''
---
module: fmgd_system_passwordpolicyguestadmin
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_passwordpolicyguestadmin': {
            ...
            'options': {
                'apply-to': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'choices': ['guest-admin-password'], 'elements': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_passwordpolicyguestadmin'),
