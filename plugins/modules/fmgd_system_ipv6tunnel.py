...
DOCUMENTATION = '''
---
module: fmgd_system_ipv6tunnel
short_description: Configure IPv6/IPv4 in IPv6 tunnel.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure IPv6/IPv4 in IPv6 tunnel.
      fortinet.fmgdevice.fmgd_system_ipv6tunnel:
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_ipv6tunnel': {
            ...
            'options': {
                ...
                'destination': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_ipv6tunnel'),
