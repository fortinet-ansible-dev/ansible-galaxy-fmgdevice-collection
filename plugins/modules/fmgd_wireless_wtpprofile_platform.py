...
DOCUMENTATION = '''
---
module: fmgd_wireless_wtpprofile_platform
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: WTP, FortiAP, or AP platform.
      fortinet.fmgdevice.fmgd_wireless_wtpprofile_platform:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_wtpprofile_platform'),
