...
DOCUMENTATION = '''
---
module: fmgd_wireless_apcfgprofile_commandlist
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: AP local configuration command list.
      fortinet.fmgdevice.fmgd_wireless_apcfgprofile_commandlist:
...
def main():
    ...
    url_params = ['device', 'vdom', 'apcfg-profile']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_apcfgprofile_commandlist'),
