...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_anqpnairealm
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure network access identifier
      fortinet.fmgdevice.fmgd_wireless_hotspot20_anqpnairealm:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_anqpnairealm'),
