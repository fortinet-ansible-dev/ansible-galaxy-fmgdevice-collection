...
DOCUMENTATION = '''
---
module: fmgd_system_proxyarp
short_description: Configure proxy-ARP.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure proxy-ARP.
      fortinet.fmgdevice.fmgd_system_proxyarp:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_proxyarp'),
