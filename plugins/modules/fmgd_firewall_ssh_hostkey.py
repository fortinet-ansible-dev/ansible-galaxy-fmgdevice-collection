...
DOCUMENTATION = '''
---
module: fmgd_firewall_ssh_hostkey
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: SSH proxy host public keys.
      fortinet.fmgdevice.fmgd_firewall_ssh_hostkey:
        ...
        firewall_ssh_hostkey:
          ...
          # hostname: <string>
          # ip: <string>
          # nid: <value in [256, 384, 521]>
          # port: <integer>
          # public_key: <string>
          # status: <value in [trusted, revoked]>
          # type: <value in [RSA, DSA, ECDSA, ...]>
          # usage: <value in [transparent-proxy, access-proxy]>
'''
...
def main():
    ...
    module_arg_spec = {
        ...
        'firewall_ssh_hostkey': {
            ...
            'options': {
                ...
                'nid': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['256', '384', '521'], 'type': 'str'},
                'port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'public-key': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'no_log': True, 'type': 'str'},
                'status': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['trusted', 'revoked'], 'type': 'str'},
                'type': {
                    'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']],
                    'choices': ['RSA', 'DSA', 'ECDSA', 'ED25519', 'RSA-CA', 'DSA-CA', 'ECDSA-CA', 'ED25519-CA'],
                    'type': 'str'
                },
                'usage': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['transparent-proxy', 'access-proxy'], 'type': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_ssh_hostkey'),
