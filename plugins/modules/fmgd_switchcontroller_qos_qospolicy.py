...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_qos_qospolicy
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure FortiSwitch QoS policy.
      fortinet.fmgdevice.fmgd_switchcontroller_qos_qospolicy:
        ...
        switchcontroller_qos_qospolicy:
          ...
          # default_cos: <integer>
          # queue_policy: <list or string>
          # trust_dot1p_map: <list or string>
          # trust_ip_dscp_map: <list or string>
'''
...
def main():
    ...
    module_arg_spec = {
        ...
        'switchcontroller_qos_qospolicy': {
            ...
            'options': {
                'default-cos': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'name': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'required': True, 'type': 'str'},
                'queue-policy': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                'trust-dot1p-map': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                'trust-ip-dscp-map': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'}
            }
        }
    }
