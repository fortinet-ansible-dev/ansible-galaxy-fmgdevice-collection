...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_h2qpadviceofcharge_aoclist
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: AOC list.
      fortinet.fmgdevice.fmgd_wireless_hotspot20_h2qpadviceofcharge_aoclist:
...
def main():
    ...
    url_params = ['device', 'vdom', 'h2qp-advice-of-charge']
    ...
    module_arg_spec = {
        ...
        'wireless_hotspot20_h2qpadviceofcharge_aoclist': {
            ...
            'options': {
                ...
                'nai-realm-encoding': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_h2qpadviceofcharge_aoclist'),
