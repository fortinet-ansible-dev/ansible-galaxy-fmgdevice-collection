...
DOCUMENTATION = '''
---
module: fmgd_wireless_utmprofile
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure UTM
      fortinet.fmgdevice.fmgd_wireless_utmprofile:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_utmprofile'),
