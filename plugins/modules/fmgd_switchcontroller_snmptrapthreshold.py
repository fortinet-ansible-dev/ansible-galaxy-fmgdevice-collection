...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_snmptrapthreshold
short_description: Configure FortiSwitch SNMP trap threshold values globally.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure FortiSwitch SNMP trap threshold values globally.
      fortinet.fmgdevice.fmgd_switchcontroller_snmptrapthreshold:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_snmptrapthreshold'),
