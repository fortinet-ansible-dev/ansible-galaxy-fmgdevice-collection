...
DOCUMENTATION = '''
---
module: fmgd_wireless_syslogprofile
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure Wireless Termination Points
      fortinet.fmgdevice.fmgd_wireless_syslogprofile:
    ...
    module_arg_spec = {
        ...
        'wireless_syslogprofile': {
            ...
            'options': {
                ...
                'server-addr-type': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['fqdn', 'ip'], 'type': 'str'},
                'server-fqdn': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'server-ip': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'server-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'server-status': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
