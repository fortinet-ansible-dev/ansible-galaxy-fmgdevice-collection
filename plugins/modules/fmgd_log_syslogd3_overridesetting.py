...
DOCUMENTATION = '''
---
module: fmgd_log_syslogd3_overridesetting
    ...
    log_syslogd3_overridesetting:
        ...
        suboptions:
            ...
            use_management_vdom:
                ...
                type: str
                description: Enable/disable use of management VDOM as source VDOM for logs sent to syslog server.
                choices:
                    - 'disable'
                    - 'enable'
            vrf_select:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Override settings for remote syslog server.
      fortinet.fmgdevice.fmgd_log_syslogd3_overridesetting:
...
def main():
    ...
    module_arg_spec = {
        ...
        'log_syslogd3_overridesetting': {
            ...
            'options': {
                ...
                'use-management-vdom': {'v_range': [['7.6.0', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'log_syslogd3_overridesetting'),
