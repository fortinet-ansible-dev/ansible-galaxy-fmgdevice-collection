...
DOCUMENTATION = '''
---
module: fmgd_system_virtualwanlink_members
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: FortiGate interfaces added to the virtual-wan-link.
      fortinet.fmgdevice.fmgd_system_virtualwanlink_members:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_virtualwanlink_members'),
