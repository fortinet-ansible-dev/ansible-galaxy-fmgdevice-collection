...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_anqproamingconsortium
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure roaming consortium.
      fortinet.fmgdevice.fmgd_wireless_hotspot20_anqproamingconsortium:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_anqproamingconsortium'),
