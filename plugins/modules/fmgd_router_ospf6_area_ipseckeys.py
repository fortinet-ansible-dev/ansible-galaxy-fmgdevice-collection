...
DOCUMENTATION = '''
---
module: fmgd_router_ospf6_area_ipseckeys
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: IPsec authentication and encryption keys.
      fortinet.fmgdevice.fmgd_router_ospf6_area_ipseckeys:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_ospf6_area_ipseckeys'),
