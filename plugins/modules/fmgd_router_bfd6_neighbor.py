...
DOCUMENTATION = '''
---
module: fmgd_router_bfd6_neighbor
short_description: Configure neighbor of IPv6 BFD.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure neighbor of IPv6 BFD.
      fortinet.fmgdevice.fmgd_router_bfd6_neighbor:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_bfd6_neighbor'),
