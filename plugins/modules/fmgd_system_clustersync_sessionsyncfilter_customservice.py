...
DOCUMENTATION = '''
---
module: fmgd_system_clustersync_sessionsyncfilter_customservice
short_description: Device system cluster sync session sync filter custom service
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Device system cluster sync session sync filter custom service
      fortinet.fmgdevice.fmgd_system_clustersync_sessionsyncfilter_customservice:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_clustersync_sessionsyncfilter_customservice'),
