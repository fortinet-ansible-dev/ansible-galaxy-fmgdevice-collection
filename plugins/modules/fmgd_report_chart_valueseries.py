...
DOCUMENTATION = '''
---
module: fmgd_report_chart_valueseries
short_description: Value series of pie chart.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Value series of pie chart.
      fortinet.fmgdevice.fmgd_report_chart_valueseries:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'report_chart_valueseries'),
