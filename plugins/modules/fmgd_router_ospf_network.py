...
DOCUMENTATION = '''
---
module: fmgd_router_ospf_network
short_description: OSPF network configuration.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: OSPF network configuration.
      fortinet.fmgdevice.fmgd_router_ospf_network:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_ospf_network'),
