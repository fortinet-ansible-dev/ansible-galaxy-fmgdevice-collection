...
DOCUMENTATION = '''
---
module: fmgd_vpn_kmipserver_serverlist
short_description: KMIP server list.
description:
...
options:
    ...
    vdom:
        ...
        required: true
    kmip-server:
        description: Deprecated, please use "kmip_server"
        type: str
    kmip_server:
        description: The parameter (kmip-server) in requested url.
        type: str
...
def main():
    ...
    url_params = ['device', 'vdom', 'kmip-server']
    module_primary_key = 'id'
    module_arg_spec = {
        'device': {'required': True, 'type': 'str'},
        'vdom': {'required': True, 'type': 'str'},
        'kmip-server': {'type': 'str', 'api_name': 'kmip_server'},
        'kmip_server': {'type': 'str'},
        'vpn_kmipserver_serverlist': {
            'type': 'dict',
            'v_range': [['7.4.3', '']],
            'options': {
                'cert': {'v_range': [['7.4.3', '']], 'type': 'list', 'elements': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'vpn_kmipserver_serverlist'),
