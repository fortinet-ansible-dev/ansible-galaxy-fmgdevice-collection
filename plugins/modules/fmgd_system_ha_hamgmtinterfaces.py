...
DOCUMENTATION = '''
---
module: fmgd_system_ha_hamgmtinterfaces
short_description: Reserve interfaces to manage individual cluster units.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Reserve interfaces to manage individual cluster units.
      fortinet.fmgdevice.fmgd_system_ha_hamgmtinterfaces:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_ha_hamgmtinterfaces'),
