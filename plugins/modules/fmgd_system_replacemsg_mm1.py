...
DOCUMENTATION = '''
---
module: fmgd_system_replacemsg_mm1
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Replacement messages.
      fortinet.fmgdevice.fmgd_system_replacemsg_mm1:
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_replacemsg_mm1': {
            ...
            'options': {
                ...
                'rsp-text': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'sender-visibility': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['hide', 'show', 'not-specified'], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_replacemsg_mm1'),
