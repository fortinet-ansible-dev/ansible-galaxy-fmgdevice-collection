...
DOCUMENTATION = '''
---
module: fmgd_router_bgp_neighbor
short_description: BGP neighbor table.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: BGP neighbor table.
      fortinet.fmgdevice.fmgd_router_bgp_neighbor:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_bgp_neighbor'),
