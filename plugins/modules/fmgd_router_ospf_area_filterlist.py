...
DOCUMENTATION = '''
---
module: fmgd_router_ospf_area_filterlist
short_description: OSPF area filter-list configuration.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: OSPF area filter-list configuration.
      fortinet.fmgdevice.fmgd_router_ospf_area_filterlist:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_ospf_area_filterlist'),
