...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_initialconfig_template
short_description: Configure template for auto-generated VLANs.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure template for auto-generated VLANs.
      fortinet.fmgdevice.fmgd_switchcontroller_initialconfig_template:
        ...
        switchcontroller_initialconfig_template:
          ...
          #   - "ftm"
          #   - "fabric"
          # auto_ip: <value in [disable, enable]>
...
def main():
        ...
        'switchcontroller_initialconfig_template': {
            ...
            'options': {
                'allowaccess': {
                    'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']],
                    'type': 'list',
                    'choices': ['https', 'ping', 'ssh', 'snmp', 'http', 'telnet', 'fgfm', 'radius-acct', 'probe-response', 'dnp', 'ftm', 'fabric'],
                    'elements': 'str'
                },
                'auto-ip': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'dhcp-server': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_initialconfig_template'),
