...
DOCUMENTATION = '''
---
module: fmgd_vpn_certificate_crl
    ...
    vpn_certificate_crl:
        ...
        suboptions:
            ...
            update_interval:
                ...
                type: int
                description: Time in seconds before the FortiGate checks for an updated CRL.
            update_vdom:
                aliases: ['update-vdom']
                type: list
                elements: str
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Certificate Revocation List as a PEM file.
      fortinet.fmgdevice.fmgd_vpn_certificate_crl:
...
def main():
    ...
    module_arg_spec = {
        ...
        'vpn_certificate_crl': {
            ...
            'options': {
                'crl': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'http-url': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'last-updated': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'ldap-password': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'no_log': True, 'type': 'list', 'elements': 'str'},
                'ldap-server': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                'ldap-username': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'name': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'required': True, 'type': 'str'},
                'range': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['global', 'vdom'], 'type': 'str'},
                'scep-cert': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                ...
                'update-vdom': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'vpn_certificate_crl'),
