...
DOCUMENTATION = '''
---
module: fmgd_system_ipam_pools
short_description: Configure IPAM pools.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure IPAM pools.
      fortinet.fmgdevice.fmgd_system_ipam_pools:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_ipam_pools'),
