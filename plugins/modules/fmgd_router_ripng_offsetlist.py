...
DOCUMENTATION = '''
---
module: fmgd_router_ripng_offsetlist
short_description: Offset list.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Offset list.
      fortinet.fmgdevice.fmgd_router_ripng_offsetlist:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_ripng_offsetlist'),
