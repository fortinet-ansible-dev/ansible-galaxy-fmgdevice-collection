...
DOCUMENTATION = '''
---
module: fmgd_system_zone_tagging
...
options:
    ...
    vdom:
        ...
        required: true
    zone:
        description: The parameter (zone) in requested url.
        type: str
        required: true
    system_zone_tagging:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Config object tagging.
      fortinet.fmgdevice.fmgd_system_zone_tagging:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_zone_tagging'),
