...
DOCUMENTATION = '''
---
module: fmgd_wireless_wtpprofile_lan
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: WTP LAN port mapping.
      fortinet.fmgdevice.fmgd_wireless_wtpprofile_lan:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_wtpprofile_lan'),
