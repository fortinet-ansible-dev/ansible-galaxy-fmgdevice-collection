...
DOCUMENTATION = '''
---
module: fmgd_vpn_certificate_setting_crlverification
short_description: CRL verification options.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: CRL verification options.
      fortinet.fmgdevice.fmgd_vpn_certificate_setting_crlverification:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'vpn_certificate_setting_crlverification'),
