...
DOCUMENTATION = '''
---
module: fmgd_ztna_webproxy_apigateway6_sslciphersuites
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: SSL/TLS cipher suites to offer to a server, ordered by priority.
      fortinet.fmgdevice.fmgd_ztna_webproxy_apigateway6_sslciphersuites:
...
def main():
    ...
    url_params = ['device', 'vdom', 'web-proxy', 'api-gateway6']
    ...
    module_arg_spec = {
        ...
        'ztna_webproxy_apigateway6_sslciphersuites': {
            ...
            'options': {
                ...
                'versions': {'v_range': [['7.6.2', '']], 'type': 'list', 'choices': ['tls-1.0', 'tls-1.1', 'tls-1.2', 'tls-1.3'], 'elements': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'ztna_webproxy_apigateway6_sslciphersuites'),
