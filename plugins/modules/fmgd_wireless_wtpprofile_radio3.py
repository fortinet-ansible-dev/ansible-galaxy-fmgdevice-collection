...
DOCUMENTATION = '''
---
module: fmgd_wireless_wtpprofile_radio3
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configuration options for radio 3.
      fortinet.fmgdevice.fmgd_wireless_wtpprofile_radio3:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_wtpprofile_radio3'),
