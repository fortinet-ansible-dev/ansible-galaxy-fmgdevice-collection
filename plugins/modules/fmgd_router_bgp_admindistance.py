...
DOCUMENTATION = '''
---
module: fmgd_router_bgp_admindistance
short_description: Administrative distance modifications.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Administrative distance modifications.
      fortinet.fmgdevice.fmgd_router_bgp_admindistance:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_bgp_admindistance'),
