...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_anqpnetworkauthtype
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure network authentication type.
      fortinet.fmgdevice.fmgd_wireless_hotspot20_anqpnetworkauthtype:
...
def main():
    ...
    module_arg_spec = {
        ...
        'wireless_hotspot20_anqpnetworkauthtype': {
            ...
            'options': {
                'auth-type': {
                    'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']],
                    'choices': ['acceptance-of-terms', 'online-enrollment', 'http-redirection', 'dns-redirection'],
                    'type': 'str'
                },
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_anqpnetworkauthtype'),
