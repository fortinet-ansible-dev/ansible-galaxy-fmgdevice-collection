...
DOCUMENTATION = '''
---
module: fmgd_report_chart_drilldowncharts
short_description: Drill down charts.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Drill down charts.
      fortinet.fmgdevice.fmgd_report_chart_drilldowncharts:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'report_chart_drilldowncharts'),
