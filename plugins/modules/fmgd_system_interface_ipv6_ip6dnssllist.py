...
DOCUMENTATION = '''
---
module: fmgd_system_interface_ipv6_ip6dnssllist
short_description: Advertised IPv6 DNSS list.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Advertised IPv6 DNSS list.
      fortinet.fmgdevice.fmgd_system_interface_ipv6_ip6dnssllist:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_interface_ipv6_ip6dnssllist'),
