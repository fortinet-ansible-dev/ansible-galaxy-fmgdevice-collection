...
DOCUMENTATION = '''
---
module: fmgd_system_csf_fabricdevice
short_description: Fabric device configuration.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Fabric device configuration.
      fortinet.fmgdevice.fmgd_system_csf_fabricdevice:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_csf_fabricdevice'),
