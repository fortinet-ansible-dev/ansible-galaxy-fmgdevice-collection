...
DOCUMENTATION = '''
---
module: fmgd_router_isis_summaryaddress
short_description: IS-IS summary addresses.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: IS-IS summary addresses.
      fortinet.fmgdevice.fmgd_router_isis_summaryaddress:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_isis_summaryaddress'),
