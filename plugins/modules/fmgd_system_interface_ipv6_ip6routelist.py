...
DOCUMENTATION = '''
---
module: fmgd_system_interface_ipv6_ip6routelist
short_description: Advertised route list.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Advertised route list.
      fortinet.fmgdevice.fmgd_system_interface_ipv6_ip6routelist:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_interface_ipv6_ip6routelist'),
