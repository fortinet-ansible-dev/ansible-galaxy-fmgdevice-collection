...
DOCUMENTATION = '''
---
module: fmgd_router_bgp_network6
short_description: BGP IPv6 network table.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: BGP IPv6 network table.
      fortinet.fmgdevice.fmgd_router_bgp_network6:
...
def main():
    ...
    module_arg_spec = {
        ...
        'router_bgp_network6': {
            ...
            'options': {
                ...
                'network-import-check': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable', 'global'], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_bgp_network6'),
