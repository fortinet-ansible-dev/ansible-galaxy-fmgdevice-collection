...
DOCUMENTATION = '''
---
module: fmgd_firewall_internetservicedefinition
short_description: Configure Internet Service definition.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure Internet Service definition.
      fortinet.fmgdevice.fmgd_firewall_internetservicedefinition:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_internetservicedefinition'),
