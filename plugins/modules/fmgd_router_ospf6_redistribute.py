...
DOCUMENTATION = '''
---
module: fmgd_router_ospf6_redistribute
short_description: Redistribute configuration.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Redistribute configuration.
      fortinet.fmgdevice.fmgd_router_ospf6_redistribute:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_ospf6_redistribute'),
