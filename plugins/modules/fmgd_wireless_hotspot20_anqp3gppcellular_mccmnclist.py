...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_anqp3gppcellular_mccmnclist
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Mobile Country Code and Mobile Network Code configuration.
      fortinet.fmgdevice.fmgd_wireless_hotspot20_anqp3gppcellular_mccmnclist:
...
def main():
    ...
    url_params = ['device', 'vdom', 'anqp-3gpp-cellular']
    ...
    module_arg_spec = {
        ...
        'wireless_hotspot20_anqp3gppcellular_mccmnclist': {
            ...
            'options': {
                ...
                'mcc': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'mnc': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_anqp3gppcellular_mccmnclist'),
