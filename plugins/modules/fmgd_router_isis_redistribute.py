...
DOCUMENTATION = '''
---
module: fmgd_router_isis_redistribute
short_description: IS-IS redistribute protocols.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_isis_redistribute'),
