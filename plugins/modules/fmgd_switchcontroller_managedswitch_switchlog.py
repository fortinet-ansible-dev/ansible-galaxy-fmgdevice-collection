...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_managedswitch_switchlog
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configuration method to edit FortiSwitch logging settings
      fortinet.fmgdevice.fmgd_switchcontroller_managedswitch_switchlog:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_managedswitch_switchlog'),
