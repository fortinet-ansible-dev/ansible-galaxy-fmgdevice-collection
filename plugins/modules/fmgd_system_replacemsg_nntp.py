...
DOCUMENTATION = '''
---
module: fmgd_system_replacemsg_nntp
short_description: Device system replacemsg nntp
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Device system replacemsg nntp
      fortinet.fmgdevice.fmgd_system_replacemsg_nntp:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_replacemsg_nntp'),
