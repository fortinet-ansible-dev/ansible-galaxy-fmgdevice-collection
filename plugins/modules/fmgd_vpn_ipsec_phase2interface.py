...
DOCUMENTATION = '''
---
module: fmgd_vpn_ipsec_phase2interface
...
def main():
    ...
    module_arg_spec = {
        ...
        'vpn_ipsec_phase2interface': {
            ...
            'options': {
                ...
                'auto-discovery-forwarder': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable', 'phase1'], 'type': 'str'},
                'auto-discovery-sender': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable', 'phase1'], 'type': 'str'},
                ...
                'dst-addr-type': {
                    'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']],
                    'choices': ['subnet', 'range', 'ip', 'name', 'subnet6', 'range6', 'ip6', 'name6'],
                    'type': 'str'
                },
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'vpn_ipsec_phase2interface'),
