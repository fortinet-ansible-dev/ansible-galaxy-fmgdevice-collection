...
DOCUMENTATION = '''
---
module: fmgd_system_ha_vcluster
short_description: Virtual cluster table.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Virtual cluster table.
      fortinet.fmgdevice.fmgd_system_ha_vcluster:
...
def main():
    ...
    url_params = ['device']
    module_primary_key = 'vcluster_id'
    module_arg_spec = {
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_ha_vcluster'),
