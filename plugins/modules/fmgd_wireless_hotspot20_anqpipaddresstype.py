...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_anqpipaddresstype
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure IP address type availability.
      fortinet.fmgdevice.fmgd_wireless_hotspot20_anqpipaddresstype:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_anqpipaddresstype'),
