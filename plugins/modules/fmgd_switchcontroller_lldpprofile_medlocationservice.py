...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_lldpprofile_medlocationservice
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configuration method to edit Media Endpoint Discovery
      fortinet.fmgdevice.fmgd_switchcontroller_lldpprofile_medlocationservice:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_lldpprofile_medlocationservice'),
