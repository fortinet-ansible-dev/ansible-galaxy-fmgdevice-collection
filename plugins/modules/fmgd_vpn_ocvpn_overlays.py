...
DOCUMENTATION = '''
---
module: fmgd_vpn_ocvpn_overlays
short_description: Network overlays to register with Overlay Controller VPN service.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Network overlays to register with Overlay Controller VPN service.
      fortinet.fmgdevice.fmgd_vpn_ocvpn_overlays:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'vpn_ocvpn_overlays'),
