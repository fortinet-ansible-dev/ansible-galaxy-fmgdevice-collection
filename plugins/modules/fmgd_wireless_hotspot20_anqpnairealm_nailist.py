...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_anqpnairealm_nailist
short_description: NAI list.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: NAI list.
      fortinet.fmgdevice.fmgd_wireless_hotspot20_anqpnairealm_nailist:
...
def main():
    ...
    url_params = ['device', 'vdom', 'anqp-nai-realm']
    ...
    module_arg_spec = {
        ...
        'wireless_hotspot20_anqpnairealm_nailist': {
            ...
            'options': {
                            ...
                            'options': {
                                ...
                                'val': {
                                    ...
                                    'choices': [
                                        ...
                                        'cred-hardware-token', 'cred-softoken', 'cred-certificate', 'cred-user-pwd', 'cred-none', 'cred-vendor-specific',
                                        'tun-cred-sim', 'tun-cred-usim', 'tun-cred-nfc', 'tun-cred-hardware-token', 'tun-cred-softoken',
                                        'tun-cred-certificate', 'tun-cred-user-pwd', 'tun-cred-anonymous', 'tun-cred-vendor-specific'
                                    ],
                                    'type': 'str'
                                }
                            },
                ...
                'encoding': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'nai-realm': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_anqpnairealm_nailist'),
