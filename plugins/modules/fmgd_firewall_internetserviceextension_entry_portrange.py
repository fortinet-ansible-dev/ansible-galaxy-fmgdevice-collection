...
DOCUMENTATION = '''
---
module: fmgd_firewall_internetserviceextension_entry_portrange
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Port ranges in the custom entry.
      fortinet.fmgdevice.fmgd_firewall_internetserviceextension_entry_portrange:
...
def main():
    ...
    url_params = ['device', 'vdom', 'internet-service-extension', 'entry']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_internetserviceextension_entry_portrange'),
