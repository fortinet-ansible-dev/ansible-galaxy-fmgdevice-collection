...
DOCUMENTATION = '''
---
module: fmgd_firewall_internetserviceextension_disableentry_ip6range
short_description: IPv6 ranges in the disable entry.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: IPv6 ranges in the disable entry.
      fortinet.fmgdevice.fmgd_firewall_internetserviceextension_disableentry_ip6range:
...
def main():
    urls_list = [
        '/pm/config/device/{device}/vdom/{vdom}/firewall/internet-service-extension/{internet-service-extension}/disable-entry/{disable-entry}/ip6-range'
    ]
    url_params = ['device', 'vdom', 'internet-service-extension', 'disable-entry']
    ...
    module_arg_spec = {
        ...
        'firewall_internetserviceextension_disableentry_ip6range': {
            ...
            'options': {
                'end-ip6': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'id': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'required': True, 'type': 'int'},
                'start-ip6': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_internetserviceextension_disableentry_ip6range'),
