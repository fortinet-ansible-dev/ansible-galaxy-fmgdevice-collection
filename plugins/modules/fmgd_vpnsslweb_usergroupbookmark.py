...
DOCUMENTATION = '''
---
module: fmgd_vpnsslweb_usergroupbookmark
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure SSL-VPN user group bookmark.
      fortinet.fmgdevice.fmgd_vpnsslweb_usergroupbookmark:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'vpnsslweb_usergroupbookmark'),
