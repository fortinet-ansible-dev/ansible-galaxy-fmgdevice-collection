...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_anqpvenueurl
short_description: Configure venue URL.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure venue URL.
      fortinet.fmgdevice.fmgd_wireless_hotspot20_anqpvenueurl:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_anqpvenueurl'),
