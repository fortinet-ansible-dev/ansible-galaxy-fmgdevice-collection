...
DOCUMENTATION = '''
---
module: fmgd_router_ospf6_summaryaddress
short_description: IPv6 address summary configuration.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: IPv6 address summary configuration.
      fortinet.fmgdevice.fmgd_router_ospf6_summaryaddress:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_ospf6_summaryaddress'),
