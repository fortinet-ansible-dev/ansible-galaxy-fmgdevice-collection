...
DOCUMENTATION = '''
---
module: fmgd_firewall_ipmacbinding_table
...
options:
    ...
    firewall_ipmacbinding_table:
        ...
        suboptions:
            ip:
                type: str
                description: IPv4 address portion of the pair
            mac:
                type: str
                description: MAC address portion of the pair
            name:
                type: str
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure IP to MAC address pairs in the IP/MAC binding table.
      fortinet.fmgdevice.fmgd_firewall_ipmacbinding_table:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_ipmacbinding_table'),
