...
DOCUMENTATION = '''
---
module: fmgd_system_dedicatedmgmt
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure dedicated management.
      fortinet.fmgdevice.fmgd_system_dedicatedmgmt:
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_dedicatedmgmt': {
            ...
            'options': {
                'default-gateway': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'dhcp-end-ip': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'dhcp-netmask': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'dhcp-server': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'dhcp-start-ip': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_dedicatedmgmt'),
