...
DOCUMENTATION = '''
---
module: fmgd_system_snmp_community_hosts
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure IPv4 SNMP managers
      fortinet.fmgdevice.fmgd_system_snmp_community_hosts:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_snmp_community_hosts'),
