...
DOCUMENTATION = '''
---
module: fmgd_log_syslogd_filter
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Filters for remote system server.
      fortinet.fmgdevice.fmgd_log_syslogd_filter:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'log_syslogd_filter'),
