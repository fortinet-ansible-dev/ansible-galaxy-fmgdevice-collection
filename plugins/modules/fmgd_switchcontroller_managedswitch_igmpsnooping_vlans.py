...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_managedswitch_igmpsnooping_vlans
short_description: Configure IGMP snooping VLAN.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure IGMP snooping VLAN.
      fortinet.fmgdevice.fmgd_switchcontroller_managedswitch_igmpsnooping_vlans:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_managedswitch_igmpsnooping_vlans'),
