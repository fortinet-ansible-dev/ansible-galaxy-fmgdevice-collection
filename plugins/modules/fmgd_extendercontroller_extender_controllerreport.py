...
DOCUMENTATION = '''
---
module: fmgd_extendercontroller_extender_controllerreport
short_description: FortiExtender controller report configuration.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: FortiExtender controller report configuration.
      fortinet.fmgdevice.fmgd_extendercontroller_extender_controllerreport:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'extendercontroller_extender_controllerreport'),
