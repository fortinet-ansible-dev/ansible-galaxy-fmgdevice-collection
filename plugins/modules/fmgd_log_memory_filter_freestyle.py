...
DOCUMENTATION = '''
---
module: fmgd_log_memory_filter_freestyle
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Free style filters.
      fortinet.fmgdevice.fmgd_log_memory_filter_freestyle:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'log_memory_filter_freestyle'),
