...
DOCUMENTATION = '''
---
module: fmgd_wireless_vapgroup
short_description: Configure virtual Access Point
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure virtual Access Point
      fortinet.fmgdevice.fmgd_wireless_vapgroup:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_vapgroup'),
