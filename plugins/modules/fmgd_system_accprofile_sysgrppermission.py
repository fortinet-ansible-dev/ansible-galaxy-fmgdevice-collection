...
DOCUMENTATION = '''
---
module: fmgd_system_accprofile_sysgrppermission
short_description: Custom system permission.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Custom system permission.
      fortinet.fmgdevice.fmgd_system_accprofile_sysgrppermission:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_accprofile_sysgrppermission'),
