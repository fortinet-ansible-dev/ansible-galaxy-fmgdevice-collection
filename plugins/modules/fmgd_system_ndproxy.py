...
DOCUMENTATION = '''
---
module: fmgd_system_ndproxy
short_description: Configure IPv6 neighbor discovery proxy
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure IPv6 neighbor discovery proxy
      fortinet.fmgdevice.fmgd_system_ndproxy:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_ndproxy'),
