...
DOCUMENTATION = '''
---
module: fmgd_router_bgp_aggregateaddress6
short_description: BGP IPv6 aggregate address table.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: BGP IPv6 aggregate address table.
      fortinet.fmgdevice.fmgd_router_bgp_aggregateaddress6:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_bgp_aggregateaddress6'),
