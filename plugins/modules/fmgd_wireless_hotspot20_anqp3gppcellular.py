...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_anqp3gppcellular
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure 3GPP public land mobile network
      fortinet.fmgdevice.fmgd_wireless_hotspot20_anqp3gppcellular:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_anqp3gppcellular'),
