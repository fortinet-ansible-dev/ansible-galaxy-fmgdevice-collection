...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_switchprofile
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure FortiSwitch switch profile.
      fortinet.fmgdevice.fmgd_switchcontroller_switchprofile:
    ...
    module_arg_spec = {
        ...
        'switchcontroller_switchprofile': {
            ...
            'options': {
                ...
                'login-passwd-override': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                ...
                'revision-backup-on-upgrade': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'}
            }
        }
    }
