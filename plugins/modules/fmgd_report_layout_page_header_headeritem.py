...
DOCUMENTATION = '''
---
module: fmgd_report_layout_page_header_headeritem
short_description: Configure report header item.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure report header item.
      fortinet.fmgdevice.fmgd_report_layout_page_header_headeritem:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'report_layout_page_header_headeritem'),
