...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure IPv4 policies.
      fortinet.fmgdevice.fmgd_firewall_policy:
        ...
        firewall_policy:
          ...
          # np_accelation: <value in [disable, enable]>
          # delay_tcp_npu_sessoin: <value in [disable, enable]>
          # casi_profile: <string>
...
def main():
    ...
    module_arg_spec = {
        ...
        'firewall_policy': {
            ...
            'options': {
                ...
                'app-category': {'type': 'str'},
                'application': {'type': 'list', 'elements': 'int'},
                ...
                'comments': {'type': 'dict'},
                'custom-log-fields': {'type': 'str'},
                'delay-tcp-npu-session': {'choices': ['disable', 'enable'], 'type': 'str'},
                'devices': {'v_range': [['6.0.0', '7.2.1']], 'type': 'str'},
                ...
                'internet-service-custom': {'type': 'str'},
                ...
                'ntlm-enabled-browsers': {'type': 'list', 'elements': 'str'},
                ...
                'app-group': {'v_range': [['6.2.0', '']], 'type': 'str'},
                ...
                'fsso-groups': {'v_range': [['6.2.1', '']], 'type': 'str'},
                ...
                'internet-service-custom-group': {'v_range': [['6.2.0', '']], 'type': 'str'},
                'internet-service-group': {'v_range': [['6.2.0', '']], 'type': 'str'},
                'internet-service-src': {'v_range': [['6.2.0', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'internet-service-src-custom': {'v_range': [['6.2.0', '']], 'type': 'str'},
                'internet-service-src-custom-group': {'v_range': [['6.2.0', '']], 'type': 'str'},
                'internet-service-src-group': {'v_range': [['6.2.0', '']], 'type': 'str'},
                'internet-service-src-id': {'v_range': [['6.2.0', '']], 'type': 'str'},
                ...
                'dstaddr6': {'v_range': [['6.4.0', '']], 'type': 'str'},
                'geoip-match': {'v_range': [['6.4.0', '']], 'choices': ['physical-location', 'registered-location'], 'type': 'str'},
                'internet-service-name': {'v_range': [['6.4.0', '']], 'type': 'str'},
                'internet-service-src-name': {'v_range': [['6.4.0', '']], 'type': 'str'},
                'poolname6': {'v_range': [['6.4.0', '']], 'type': 'str'},
                'src-vendor-mac': {'v_range': [['6.4.0', '']], 'type': 'str'},
                'srcaddr6': {'v_range': [['6.4.0', '']], 'type': 'str'},
                ...
                'ztna-ems-tag': {'v_range': [['7.0.0', '']], 'type': 'str'},
                'ztna-geo-tag': {'v_range': [['7.0.0', '']], 'type': 'str'},
                ...
                'sgt': {'v_range': [['7.0.1', '']], 'type': 'list', 'elements': 'int'},
                ...
                'internet-service6-custom': {'v_range': [['7.2.1', '']], 'type': 'list', 'elements': 'str'},
                'internet-service6-custom-group': {'v_range': [['7.2.1', '']], 'type': 'list', 'elements': 'str'},
                'internet-service6-group': {'v_range': [['7.2.1', '']], 'type': 'list', 'elements': 'str'},
                'internet-service6-name': {'v_range': [['7.2.1', '']], 'type': 'list', 'elements': 'str'},
                ...
                'internet-service6-src-custom': {'v_range': [['7.2.1', '']], 'type': 'list', 'elements': 'str'},
                'internet-service6-src-custom-group': {'v_range': [['7.2.1', '']], 'type': 'list', 'elements': 'str'},
                'internet-service6-src-group': {'v_range': [['7.2.1', '']], 'type': 'list', 'elements': 'str'},
                'internet-service6-src-name': {'v_range': [['7.2.1', '']], 'type': 'list', 'elements': 'str'},
                'internet-service6-src-negate': {'v_range': [['7.2.1', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'network-service-dynamic': {'v_range': [['7.2.1', '']], 'type': 'list', 'elements': 'str'},
                'network-service-src-dynamic': {'v_range': [['7.2.1', '']], 'type': 'list', 'elements': 'str'},
                ...
                'pcp-poolname': {'v_range': [['7.4.0', '']], 'type': 'list', 'elements': 'str'},
                ...
                'ztna-ems-tag-secondary': {'v_range': [['7.4.0', '']], 'type': 'list', 'elements': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_policy'),
