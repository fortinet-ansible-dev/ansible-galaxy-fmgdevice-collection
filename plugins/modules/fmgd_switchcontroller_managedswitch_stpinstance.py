...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_managedswitch_stpinstance
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configuration method to edit Spanning Tree Protocol
      fortinet.fmgdevice.fmgd_switchcontroller_managedswitch_stpinstance:
...
def main():
        ...
        'switchcontroller_managedswitch_stpinstance': {
            ...
            'options': {
                ...
                'priority': {
                    ...
                    'choices': [
                        '0', '4096', '8192', '12288', '12328', '16384', '20480', '24576', '28672', '32768', '36864', '40960', '45056', '49152', '53248',
                        '57344', '61440'
                    ],
                    'type': 'str'
                }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_managedswitch_stpinstance'),
