...
DOCUMENTATION = '''
---
module: fmgd_wanopt_cacheservice_dstpeer
short_description: Modify cache-service destination peer list.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Modify cache-service destination peer list.
      fortinet.fmgdevice.fmgd_wanopt_cacheservice_dstpeer:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wanopt_cacheservice_dstpeer'),
