...
DOCUMENTATION = '''
---
module: fmgd_router_isis_summaryaddress6
short_description: IS-IS IPv6 summary address.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: IS-IS IPv6 summary address.
      fortinet.fmgdevice.fmgd_router_isis_summaryaddress6:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_isis_summaryaddress6'),
