...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_location_addresscivic
short_description: Configure location civic address.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure location civic address.
      fortinet.fmgdevice.fmgd_switchcontroller_location_addresscivic:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_location_addresscivic'),
