...
DOCUMENTATION = '''
---
module: fmgd_report_chart_column
short_description: Table column definition.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Table column definition.
      fortinet.fmgdevice.fmgd_report_chart_column:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'report_chart_column'),
