...
DOCUMENTATION = '''
---
module: fmgd_router_ripng_interface
short_description: RIPng interface configuration.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: RIPng interface configuration.
      fortinet.fmgdevice.fmgd_router_ripng_interface:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_ripng_interface'),
