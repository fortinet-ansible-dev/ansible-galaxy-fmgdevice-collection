...
DOCUMENTATION = '''
---
module: fmgd_router_bgp_vrfleak
short_description: BGP VRF leaking table.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: BGP VRF leaking table.
      fortinet.fmgdevice.fmgd_router_bgp_vrfleak:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_bgp_vrfleak'),
