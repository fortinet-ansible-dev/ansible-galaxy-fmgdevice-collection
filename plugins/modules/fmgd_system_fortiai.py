...
DOCUMENTATION = '''
---
module: fmgd_system_fortiai
short_description: Configure FortiAI.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure FortiAI.
      fortinet.fmgdevice.fmgd_system_fortiai:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_fortiai'),
