...
DOCUMENTATION = '''
---
module: fmgd_system_ipiptunnel
short_description: Configure IP in IP Tunneling.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure IP in IP Tunneling.
      fortinet.fmgdevice.fmgd_system_ipiptunnel:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_ipiptunnel'),
