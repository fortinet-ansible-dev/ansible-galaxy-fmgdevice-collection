...
DOCUMENTATION = '''
---
module: fmgd_log_fortiguard_overridesetting
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Override global FortiCloud logging settings for this VDOM.
      fortinet.fmgdevice.fmgd_log_fortiguard_overridesetting:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'log_fortiguard_overridesetting'),
