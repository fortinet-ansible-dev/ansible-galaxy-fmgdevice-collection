...
DOCUMENTATION = '''
---
module: fmgd_ztna_webproxy_apigateway6_quic
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: QUIC setting.
      fortinet.fmgdevice.fmgd_ztna_webproxy_apigateway6_quic:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'ztna_webproxy_apigateway6_quic'),
