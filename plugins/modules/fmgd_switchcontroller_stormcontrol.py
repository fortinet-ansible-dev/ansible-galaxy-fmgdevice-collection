...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_stormcontrol
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure FortiSwitch storm control.
      fortinet.fmgdevice.fmgd_switchcontroller_stormcontrol:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_stormcontrol'),
