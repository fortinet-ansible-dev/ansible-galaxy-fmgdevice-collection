...
DOCUMENTATION = '''
---
module: fmgd_firewall_internetserviceextension_disableentry
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Disable entries in the Internet Service database.
      fortinet.fmgdevice.fmgd_firewall_internetserviceextension_disableentry:
...
def main():
    ...
    url_params = ['device', 'vdom', 'internet-service-extension']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_internetserviceextension_disableentry'),
