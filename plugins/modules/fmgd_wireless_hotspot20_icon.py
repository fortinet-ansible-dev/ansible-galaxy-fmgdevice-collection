...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_icon
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure OSU provider icon.
      fortinet.fmgdevice.fmgd_wireless_hotspot20_icon:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_icon'),
