...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_managedswitch_ipsourceguard
short_description: IP source guard.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: IP source guard.
      fortinet.fmgdevice.fmgd_switchcontroller_managedswitch_ipsourceguard:
        ...
        switchcontroller_managedswitch_ipsourceguard:
          port: "your value" # Required variable, string
          # binding_entry:
          #   - entry_name: <string>
          #     ip: <string>
          #     mac: <string>
...
def main():
    ...
    module_arg_spec = {
        ...
        'switchcontroller_managedswitch_ipsourceguard': {
            ...
            'options': {
                ...
                'port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'required': True, 'type': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_managedswitch_ipsourceguard'),
