...
DOCUMENTATION = '''
---
module: fmgd_system_macaddresstable
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure MAC address tables.
      fortinet.fmgdevice.fmgd_system_macaddresstable:
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_macaddresstable': {
            ...
            'options': {
                ...
                'reply-substitute': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_macaddresstable'),
