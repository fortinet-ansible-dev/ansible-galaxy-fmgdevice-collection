...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_qosmap_dscprange
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Differentiated Services Code Point
      fortinet.fmgdevice.fmgd_wireless_hotspot20_qosmap_dscprange:
...
def main():
    ...
    url_params = ['device', 'vdom', 'qos-map']
    module_primary_key = 'index'
    module_arg_spec = {
        'device': {'required': True, 'type': 'str'},
        'vdom': {'required': True, 'type': 'str'},
        'qos-map': {'type': 'str', 'api_name': 'qos_map'},
        'qos_map': {'type': 'str'},
        'wireless_hotspot20_qosmap_dscprange': {
            'type': 'dict',
            'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']],
            'options': {
                'high': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'index': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'required': True, 'type': 'int'},
                'low': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'up': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_qosmap_dscprange'),
