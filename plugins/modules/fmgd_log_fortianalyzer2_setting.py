...
DOCUMENTATION = '''
---
module: fmgd_log_fortianalyzer2_setting
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Global FortiAnalyzer settings.
      fortinet.fmgdevice.fmgd_log_fortianalyzer2_setting:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'log_fortianalyzer2_setting'),
