...
DOCUMENTATION = '''
---
module: fmgd_azure_vwanslb_permanentsecurityrules_rules
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure security rules.
      fortinet.fmgdevice.fmgd_azure_vwanslb_permanentsecurityrules_rules:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'azure_vwanslb_permanentsecurityrules_rules'),
