...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_qosmap
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure QoS map set.
      fortinet.fmgdevice.fmgd_wireless_hotspot20_qosmap:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_qosmap'),
