...
DOCUMENTATION = '''
---
module: fmgd_firewall_internetserviceextension_disableentry_iprange
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: IPv4 ranges in the disable entry.
      fortinet.fmgdevice.fmgd_firewall_internetserviceextension_disableentry_iprange:
...
def main():
    urls_list = [
        '/pm/config/device/{device}/vdom/{vdom}/firewall/internet-service-extension/{internet-service-extension}/disable-entry/{disable-entry}/ip-range'
    ]
