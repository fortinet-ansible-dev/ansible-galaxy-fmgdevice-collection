...
DOCUMENTATION = '''
---
module: fmgd_system_autoupdate_tunneling
short_description: Configure web proxy tunneling for the FDN.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure web proxy tunneling for the FDN.
      fortinet.fmgdevice.fmgd_system_autoupdate_tunneling:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_autoupdate_tunneling'),
