...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_acl_group
short_description: Configure ACL groups to be applied on managed FortiSwitch ports.
description:
...
def main():
    ...
    module_arg_spec = {
        ...
        'switchcontroller_acl_group': {
            ...
            'v_range': [['7.4.3', '']],
            'options': {
                'ingress': {'v_range': [['7.4.3', '']], 'type': 'list', 'elements': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_acl_group'),
