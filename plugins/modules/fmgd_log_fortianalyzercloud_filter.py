...
DOCUMENTATION = '''
---
module: fmgd_log_fortianalyzercloud_filter
short_description: Filters for FortiAnalyzer Cloud.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Filters for FortiAnalyzer Cloud.
      fortinet.fmgdevice.fmgd_log_fortianalyzercloud_filter:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'log_fortianalyzercloud_filter'),
