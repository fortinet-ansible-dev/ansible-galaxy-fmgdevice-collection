...
DOCUMENTATION = '''
---
module: fmgd_system_interface_clientoptions
short_description: DHCP client options.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: DHCP client options.
      fortinet.fmgdevice.fmgd_system_interface_clientoptions:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_interface_clientoptions'),
