...
DOCUMENTATION = '''
---
module: fmgd_system_arptable
short_description: Configure ARP table.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure ARP table.
      fortinet.fmgdevice.fmgd_system_arptable:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_arptable'),
