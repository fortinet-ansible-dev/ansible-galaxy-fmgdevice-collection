...
DOCUMENTATION = '''
---
module: fmgd_log_azuresecuritycenter2_filter
short_description: Filters for Azure Security Center.
description:
...
options:
    ...
    log_azuresecuritycenter2_filter:
        ...
        suboptions:
            ...
            filter:
                type: str
                description: Log filter for the log device.
            dns:
                type: str
                description: Dns.
                choices:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Filters for Azure Security Center.
      fortinet.fmgdevice.fmgd_log_azuresecuritycenter2_filter:
...
def main():
    ...
    module_arg_spec = {
        ...
        'log_azuresecuritycenter2_filter': {
            ...
            'options': {
                ...
                'filter-type': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['include', 'exclude'], 'type': 'str'},
                'filter': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'dns': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'ssl': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'ssh': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'log_azuresecuritycenter2_filter'),
