...
DOCUMENTATION = '''
---
module: fmgd_system_sflow_collectors
short_description: sFlow collectors.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: SFlow collectors.
      fortinet.fmgdevice.fmgd_system_sflow_collectors:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_sflow_collectors'),
