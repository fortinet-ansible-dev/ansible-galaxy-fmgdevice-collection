...
DOCUMENTATION = '''
---
module: fmgd_vpn_ocvpn_overlays_subnets
short_description: Internal subnets to register with OCVPN service.
description:
...
options:
    ...
    vdom:
        ...
        required: true
    overlays:
        description: The parameter (overlays) in requested url.
        type: str
        required: true
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Internal subnets to register with OCVPN service.
      fortinet.fmgdevice.fmgd_vpn_ocvpn_overlays_subnets:
...
def main():
    ...
    url_params = ['device', 'vdom', 'overlays']
    module_primary_key = 'id'
    module_arg_spec = {
        'device': {'required': True, 'type': 'str'},
        'vdom': {'required': True, 'type': 'str'},
        'overlays': {'required': True, 'type': 'str'},
        'vpn_ocvpn_overlays_subnets': {
            'type': 'dict',
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'vpn_ocvpn_overlays_subnets'),
