...
DOCUMENTATION = '''
---
module: fmgd_system_interface_tagging
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Config object tagging.
      fortinet.fmgdevice.fmgd_system_interface_tagging:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_interface_tagging'),
