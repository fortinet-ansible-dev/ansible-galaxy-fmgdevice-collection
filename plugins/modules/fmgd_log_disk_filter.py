...
DOCUMENTATION = '''
---
module: fmgd_log_disk_filter
short_description: Configure filters for local disk logging.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure filters for local disk logging.
      fortinet.fmgdevice.fmgd_log_disk_filter:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'log_disk_filter'),
