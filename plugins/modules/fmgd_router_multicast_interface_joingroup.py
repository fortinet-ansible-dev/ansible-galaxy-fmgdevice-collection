...
DOCUMENTATION = '''
---
module: fmgd_router_multicast_interface_joingroup
short_description: Join multicast groups.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Join multicast groups.
      fortinet.fmgdevice.fmgd_router_multicast_interface_joingroup:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_multicast_interface_joingroup'),
