...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_nacsettings
short_description: Configure integrated NAC settings for FortiSwitch.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure integrated NAC settings for FortiSwitch.
      fortinet.fmgdevice.fmgd_switchcontroller_nacsettings:
...
def main():
    ...
    module_arg_spec = {
        ...
        'switchcontroller_nacsettings': {
            ...
            'options': {
                'auto-auth': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'bounce-nac-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'inactive-timer': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'link-down-flush': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'mode': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['local', 'global'], 'type': 'str'},
                'name': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'required': True, 'type': 'str'},
                'onboarding-vlan': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_nacsettings'),
