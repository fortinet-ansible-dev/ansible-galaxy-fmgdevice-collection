...
DOCUMENTATION = '''
---
module: fmgd_user_quarantine_targets
short_description: Quarantine entry to hold multiple MACs.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Quarantine entry to hold multiple MACs.
      fortinet.fmgdevice.fmgd_user_quarantine_targets:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'user_quarantine_targets'),
