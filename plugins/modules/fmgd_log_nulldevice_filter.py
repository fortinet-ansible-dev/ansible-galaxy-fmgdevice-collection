...
DOCUMENTATION = '''
---
module: fmgd_log_nulldevice_filter
short_description: Filters for null device logging.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Filters for null device logging.
      fortinet.fmgdevice.fmgd_log_nulldevice_filter:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'log_nulldevice_filter'),
