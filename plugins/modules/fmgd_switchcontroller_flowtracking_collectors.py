...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_flowtracking_collectors
short_description: Configure collectors for the flow.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure collectors for the flow.
      fortinet.fmgdevice.fmgd_switchcontroller_flowtracking_collectors:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_flowtracking_collectors'),
