...
DOCUMENTATION = '''
---
module: fmgd_ztna_trafficforwardproxy_sslciphersuites
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: SSL/TLS cipher suites acceptable from a client, ordered by priority.
      fortinet.fmgdevice.fmgd_ztna_trafficforwardproxy_sslciphersuites:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'ztna_trafficforwardproxy_sslciphersuites'),
