...
DOCUMENTATION = '''
---
module: fmgd_wireless_bonjourprofile
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure Bonjour profiles.
      fortinet.fmgdevice.fmgd_wireless_bonjourprofile:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_bonjourprofile'),
