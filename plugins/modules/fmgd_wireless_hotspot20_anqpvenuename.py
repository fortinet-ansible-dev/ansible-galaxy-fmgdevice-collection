...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_anqpvenuename
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure venue name duple.
      fortinet.fmgdevice.fmgd_wireless_hotspot20_anqpvenuename:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_anqpvenuename'),
