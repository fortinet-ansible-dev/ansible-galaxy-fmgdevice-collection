...
DOCUMENTATION = '''
---
module: fmgd_system_pcpserver_pools
short_description: Configure PCP pools.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_pcpserver_pools'),
