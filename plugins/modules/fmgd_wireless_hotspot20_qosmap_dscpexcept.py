...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_qosmap_dscpexcept
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Differentiated Services Code Point
      fortinet.fmgdevice.fmgd_wireless_hotspot20_qosmap_dscpexcept:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_qosmap_dscpexcept'),
