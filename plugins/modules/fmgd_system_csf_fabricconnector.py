...
DOCUMENTATION = '''
---
module: fmgd_system_csf_fabricconnector
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Fabric connector configuration.
      fortinet.fmgdevice.fmgd_system_csf_fabricconnector:
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_csf_fabricconnector': {
            ...
            'options': {
                ...
                'serial': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'required': True, 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_csf_fabricconnector'),
