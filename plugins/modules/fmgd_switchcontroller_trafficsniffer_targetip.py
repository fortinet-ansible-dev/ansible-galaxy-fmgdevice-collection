...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_trafficsniffer_targetip
short_description: Sniffer IPs to filter.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Sniffer IPs to filter.
      fortinet.fmgdevice.fmgd_switchcontroller_trafficsniffer_targetip:
...
def main():
    ...
    module_arg_spec = {
        ...
        'switchcontroller_trafficsniffer_targetip': {
            ...
            'options': {
                ...
                'ip': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'required': True, 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_trafficsniffer_targetip'),
