...
DOCUMENTATION = '''
---
module: fmgd_system_sdwan_zone
short_description: Configure SD-WAN zones.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_sdwan_zone'),
