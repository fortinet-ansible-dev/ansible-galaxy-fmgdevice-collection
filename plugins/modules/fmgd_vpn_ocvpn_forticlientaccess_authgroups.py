...
DOCUMENTATION = '''
---
module: fmgd_vpn_ocvpn_forticlientaccess_authgroups
short_description: FortiClient user authentication groups.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: FortiClient user authentication groups.
      fortinet.fmgdevice.fmgd_vpn_ocvpn_forticlientaccess_authgroups:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'vpn_ocvpn_forticlientaccess_authgroups'),
