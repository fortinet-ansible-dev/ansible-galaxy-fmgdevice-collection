...
DOCUMENTATION = '''
---
module: fmgd_firewall_ssh_localkey
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: SSH proxy local keys.
      fortinet.fmgdevice.fmgd_firewall_ssh_localkey:
...
def main():
    ...
    module_arg_spec = {
        ...
        'firewall_ssh_localkey': {
            ...
            'options': {
                ...
                'source': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['built-in', 'user'], 'type': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_ssh_localkey'),
