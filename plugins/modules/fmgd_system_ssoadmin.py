...
DOCUMENTATION = '''
---
module: fmgd_system_ssoadmin
short_description: Configure SSO admin users.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_ssoadmin'),
