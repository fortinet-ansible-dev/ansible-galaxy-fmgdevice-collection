...
DOCUMENTATION = '''
---
module: fmgd_router_rip_redistribute
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Redistribute configuration.
      fortinet.fmgdevice.fmgd_router_rip_redistribute:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_rip_redistribute'),
