...
DOCUMENTATION = '''
---
module: fmgd_system_interface_ipv6_ip6rdnsslist
short_description: Advertised IPv6 RDNSS list.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Advertised IPv6 RDNSS list.
      fortinet.fmgdevice.fmgd_system_interface_ipv6_ip6rdnsslist:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_interface_ipv6_ip6rdnsslist'),
