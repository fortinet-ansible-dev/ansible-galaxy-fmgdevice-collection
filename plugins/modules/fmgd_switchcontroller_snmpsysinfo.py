...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_snmpsysinfo
short_description: Configure FortiSwitch SNMP system information globally.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure FortiSwitch SNMP system information globally.
      fortinet.fmgdevice.fmgd_switchcontroller_snmpsysinfo:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_snmpsysinfo'),
