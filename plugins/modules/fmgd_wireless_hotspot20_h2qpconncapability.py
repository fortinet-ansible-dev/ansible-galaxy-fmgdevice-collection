...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_h2qpconncapability
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure connection capability.
      fortinet.fmgdevice.fmgd_wireless_hotspot20_h2qpconncapability:
...
def main():
    ...
    module_arg_spec = {
        ...
        'wireless_hotspot20_h2qpconncapability': {
            ...
            'options': {
                'esp-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['closed', 'open', 'unknown'], 'type': 'str'},
                'ftp-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['closed', 'open', 'unknown'], 'type': 'str'},
                'http-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['closed', 'open', 'unknown'], 'type': 'str'},
                'icmp-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['closed', 'open', 'unknown'], 'type': 'str'},
                'ikev2-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['closed', 'open', 'unknown'], 'type': 'str'},
                'ikev2-xx-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['closed', 'open', 'unknown'], 'type': 'str'},
                'name': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'required': True, 'type': 'str'},
                'pptp-vpn-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['closed', 'open', 'unknown'], 'type': 'str'},
                'ssh-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['closed', 'open', 'unknown'], 'type': 'str'},
                'tls-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['closed', 'open', 'unknown'], 'type': 'str'},
                'voip-tcp-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['closed', 'open', 'unknown'], 'type': 'str'},
                'voip-udp-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['closed', 'open', 'unknown'], 'type': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_h2qpconncapability'),
