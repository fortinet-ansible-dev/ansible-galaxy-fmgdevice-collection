...
DOCUMENTATION = '''
---
module: fmgd_log_tacacsaccounting2_setting
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Settings for TACACS+ accounting.
      fortinet.fmgdevice.fmgd_log_tacacsaccounting2_setting:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'log_tacacsaccounting2_setting'),
