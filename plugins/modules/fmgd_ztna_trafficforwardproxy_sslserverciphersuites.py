...
DOCUMENTATION = '''
---
module: fmgd_ztna_trafficforwardproxy_sslserverciphersuites
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: SSL/TLS cipher suites to offer to a server, ordered by priority.
      fortinet.fmgdevice.fmgd_ztna_trafficforwardproxy_sslserverciphersuites:
...
def main():
    ...
    url_params = ['device', 'vdom', 'traffic-forward-proxy']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'ztna_trafficforwardproxy_sslserverciphersuites'),
