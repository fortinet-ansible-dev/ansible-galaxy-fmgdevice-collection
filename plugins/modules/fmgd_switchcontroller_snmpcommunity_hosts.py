...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_snmpcommunity_hosts
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure IPv4 SNMP managers
      fortinet.fmgdevice.fmgd_switchcontroller_snmpcommunity_hosts:
...
def main():
    ...
    url_params = ['device', 'vdom', 'snmp-community']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_snmpcommunity_hosts'),
