...
DOCUMENTATION = '''
---
module: fmgd_log_fortianalyzercloud_setting
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Global FortiAnalyzer Cloud settings.
      fortinet.fmgdevice.fmgd_log_fortianalyzercloud_setting:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'log_fortianalyzercloud_setting'),
