...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_managedswitch_snmpcommunity_hosts
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure IPv4 SNMP managers
      fortinet.fmgdevice.fmgd_switchcontroller_managedswitch_snmpcommunity_hosts:
...
def main():
    ...
    url_params = ['device', 'vdom', 'managed-switch', 'snmp-community']
