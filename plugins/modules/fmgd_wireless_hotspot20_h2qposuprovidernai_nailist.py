...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_h2qposuprovidernai_nailist
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: OSU NAI list.
      fortinet.fmgdevice.fmgd_wireless_hotspot20_h2qposuprovidernai_nailist:
...
def main():
    ...
    url_params = ['device', 'vdom', 'h2qp-osu-provider-nai']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_h2qposuprovidernai_nailist'),
