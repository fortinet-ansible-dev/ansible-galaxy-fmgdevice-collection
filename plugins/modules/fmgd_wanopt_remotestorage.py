...
DOCUMENTATION = '''
---
module: fmgd_wanopt_remotestorage
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure a remote cache device as Web cache storage.
      fortinet.fmgdevice.fmgd_wanopt_remotestorage:
...
def main():
    ...
    module_arg_spec = {
        ...
        'wanopt_remotestorage': {
            ...
            'options': {
                'local-cache-id': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'remote-cache-id': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'remote-cache-ip': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wanopt_remotestorage'),
