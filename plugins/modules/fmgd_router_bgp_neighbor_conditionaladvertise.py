...
DOCUMENTATION = '''
---
module: fmgd_router_bgp_neighbor_conditionaladvertise
short_description: Conditional advertisement.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Conditional advertisement.
      fortinet.fmgdevice.fmgd_router_bgp_neighbor_conditionaladvertise:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_bgp_neighbor_conditionaladvertise'),
