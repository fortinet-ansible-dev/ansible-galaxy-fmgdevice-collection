...
DOCUMENTATION = '''
---
module: fmgd_system_accprofile_netgrppermission
short_description: Custom network permission.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Custom network permission.
      fortinet.fmgdevice.fmgd_system_accprofile_netgrppermission:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_accprofile_netgrppermission'),
