...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_trafficsniffer_targetport
short_description: Sniffer ports to filter.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Sniffer ports to filter.
      fortinet.fmgdevice.fmgd_switchcontroller_trafficsniffer_targetport:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_trafficsniffer_targetport'),
