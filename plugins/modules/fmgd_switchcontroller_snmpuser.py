...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_snmpuser
short_description: Configure FortiSwitch SNMP v3 users globally.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure FortiSwitch SNMP v3 users globally.
      fortinet.fmgdevice.fmgd_switchcontroller_snmpuser:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_snmpuser'),
