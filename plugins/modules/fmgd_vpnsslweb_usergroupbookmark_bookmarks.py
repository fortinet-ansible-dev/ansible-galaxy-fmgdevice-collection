...
DOCUMENTATION = '''
---
module: fmgd_vpnsslweb_usergroupbookmark_bookmarks
...
options:
    ...
    vdom:
        ...
        required: true
    user-group-bookmark:
        description: Deprecated, please use "user_group_bookmark"
        type: str
    user_group_bookmark:
        description: The parameter (user-group-bookmark) in requested url.
        type: str
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Bookmark table.
      fortinet.fmgdevice.fmgd_vpnsslweb_usergroupbookmark_bookmarks:
        ...
        vdom: <your own value>
        user_group_bookmark: <your own value>
...
def main():
    ...
    url_params = ['device', 'vdom', 'user-group-bookmark']
    module_primary_key = 'name'
    module_arg_spec = {
        'device': {'required': True, 'type': 'str'},
        'vdom': {'required': True, 'type': 'str'},
        'user-group-bookmark': {'type': 'str', 'api_name': 'user_group_bookmark'},
        'user_group_bookmark': {'type': 'str'},
        'vpnsslweb_usergroupbookmark_bookmarks': {
            'type': 'dict',
            ...
            'options': {
                ...
                'apptype': {
                    'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']],
                    'choices': ['web', 'ftp', 'telnet', 'smb', 'vnc', 'rdp', 'ssh', 'citrix', 'portforward', 'sftp'],
                    'type': 'str'
                },
                ...
                'keyboard-layout': {
                    'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']],
                    'choices': [
                        'da', 'de', 'de-ch', 'en-uk', 'en-us', 'es', 'fi', 'fr', 'fr-be', 'fr-ca', 'fr-ch', 'hr', 'hu', 'it', 'ja', 'lt', 'mk', 'no',
                        'pt', 'pt-br', 'ru', 'sl', 'sv', 'ar-101', 'ar-102', 'ar-102-azerty', 'can-mul', 'cz', 'cz-qwerty', 'cz-pr', 'nl', 'de-ibm',
                        'en-uk-ext', 'en-us-dvorak', 'es-var', 'fi-sami', 'hu-101', 'it-142', 'ko', 'lt-ibm', 'lt-std', 'lav-std', 'lav-leg', 'mk-std',
                        'no-sami', 'pol-214', 'pol-pr', 'pt-br-abnt2', 'ru-mne', 'ru-t', 'sv-sami', 'tuk', 'tur-f', 'tur-q', 'zh-sym-sg-us', 'zh-sym-us',
                        'zh-tr-hk', 'zh-tr-mo', 'zh-tr-us', 'fr-apple', 'la-am', 'ja-106'
                    ],
                    'type': 'str'
                },
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'vpnsslweb_usergroupbookmark_bookmarks'),
