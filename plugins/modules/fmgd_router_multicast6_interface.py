...
DOCUMENTATION = '''
---
module: fmgd_router_multicast6_interface
short_description: Protocol Independent Multicast
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Protocol Independent Multicast
      fortinet.fmgdevice.fmgd_router_multicast6_interface:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_multicast6_interface'),
