...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_virtualportpool
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure virtual pool.
      fortinet.fmgdevice.fmgd_switchcontroller_virtualportpool:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_virtualportpool'),
