...
DOCUMENTATION = '''
---
module: fmgd_vpn_ipsec_forticlient
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure FortiClient policy realm.
      fortinet.fmgdevice.fmgd_vpn_ipsec_forticlient:
...
def main():
    ...
    module_arg_spec = {
        ...
        'vpn_ipsec_forticlient': {
            ...
            'options': {
                'phase2name': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                'realm': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'required': True, 'type': 'str'},
                'status': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'usergroupname': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'vpn_ipsec_forticlient'),
