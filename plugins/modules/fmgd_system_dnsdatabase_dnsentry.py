...
DOCUMENTATION = '''
---
module: fmgd_system_dnsdatabase_dnsentry
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: DNS entry.
      fortinet.fmgdevice.fmgd_system_dnsdatabase_dnsentry:
...
def main():
    ...
    url_params = ['device', 'vdom', 'dns-database']
    module_primary_key = 'id'
    module_arg_spec = {
        'device': {'required': True, 'type': 'str'},
        'vdom': {'required': True, 'type': 'str'},
        'dns-database': {'type': 'str', 'api_name': 'dns_database'},
        'dns_database': {'type': 'str'},
        'system_dnsdatabase_dnsentry': {
            'type': 'dict',
            ...
            'options': {
                ...
                'type': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['NS', 'MX', 'CNAME', 'A', 'AAAA', 'PTR', 'PTR_V6'], 'type': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_dnsdatabase_dnsentry'),
