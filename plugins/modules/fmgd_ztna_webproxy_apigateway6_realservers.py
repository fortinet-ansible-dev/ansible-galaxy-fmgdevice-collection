...
DOCUMENTATION = '''
---
module: fmgd_ztna_webproxy_apigateway6_realservers
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Select the real servers that this Access Proxy will distribute traffic to.
      fortinet.fmgdevice.fmgd_ztna_webproxy_apigateway6_realservers:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'ztna_webproxy_apigateway6_realservers'),
