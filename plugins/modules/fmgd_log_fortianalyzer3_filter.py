...
DOCUMENTATION = '''
---
module: fmgd_log_fortianalyzer3_filter
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Filters for FortiAnalyzer.
      fortinet.fmgdevice.fmgd_log_fortianalyzer3_filter:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'log_fortianalyzer3_filter'),
