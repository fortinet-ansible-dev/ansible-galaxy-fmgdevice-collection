...
DOCUMENTATION = '''
---
module: fmgd_system_ipv6neighborcache
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure IPv6 neighbor cache table.
      fortinet.fmgdevice.fmgd_system_ipv6neighborcache:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_ipv6neighborcache'),
