...
DOCUMENTATION = '''
---
module: fmgd_vpn_ocvpn_forticlientaccess
short_description: Configure FortiClient settings.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure FortiClient settings.
      fortinet.fmgdevice.fmgd_vpn_ocvpn_forticlientaccess:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'vpn_ocvpn_forticlientaccess'),
