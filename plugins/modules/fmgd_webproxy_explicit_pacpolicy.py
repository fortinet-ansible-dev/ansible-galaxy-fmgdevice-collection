...
DOCUMENTATION = '''
---
module: fmgd_webproxy_explicit_pacpolicy
short_description: PAC policies.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: PAC policies.
      fortinet.fmgdevice.fmgd_webproxy_explicit_pacpolicy:
...
def main():
    ...
    module_arg_spec = {
        ...
        'webproxy_explicit_pacpolicy': {
            ...
            'options': {
                ...
                'policyid': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'required': True, 'type': 'int'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'webproxy_explicit_pacpolicy'),
