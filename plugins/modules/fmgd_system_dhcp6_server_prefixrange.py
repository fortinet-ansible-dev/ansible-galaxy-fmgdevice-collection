...
DOCUMENTATION = '''
---
module: fmgd_system_dhcp6_server_prefixrange
short_description: DHCP prefix configuration.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: DHCP prefix configuration.
      fortinet.fmgdevice.fmgd_system_dhcp6_server_prefixrange:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_dhcp6_server_prefixrange'),
