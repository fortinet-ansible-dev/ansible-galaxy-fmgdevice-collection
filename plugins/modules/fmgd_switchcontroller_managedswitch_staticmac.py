...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_managedswitch_staticmac
short_description: Configuration method to edit FortiSwitch Static and Sticky MAC.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configuration method to edit FortiSwitch Static and Sticky MAC.
      fortinet.fmgdevice.fmgd_switchcontroller_managedswitch_staticmac:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_managedswitch_staticmac'),
