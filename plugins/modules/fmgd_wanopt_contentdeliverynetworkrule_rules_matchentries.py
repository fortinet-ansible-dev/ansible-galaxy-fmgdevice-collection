...
DOCUMENTATION = '''
---
module: fmgd_wanopt_contentdeliverynetworkrule_rules_matchentries
short_description: List of entries to match.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: List of entries to match.
      fortinet.fmgdevice.fmgd_wanopt_contentdeliverynetworkrule_rules_matchentries:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wanopt_contentdeliverynetworkrule_rules_matchentries'),
