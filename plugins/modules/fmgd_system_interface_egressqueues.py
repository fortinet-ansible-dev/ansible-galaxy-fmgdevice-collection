...
DOCUMENTATION = '''
---
module: fmgd_system_interface_egressqueues
short_description: Configure queues of NP port on egress path.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure queues of NP port on egress path.
      fortinet.fmgdevice.fmgd_system_interface_egressqueues:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_interface_egressqueues'),
