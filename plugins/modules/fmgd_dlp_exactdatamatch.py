...
DOCUMENTATION = '''
---
module: fmgd_dlp_exactdatamatch
        ...
        'dlp_exactdatamatch': {
            ...
            'options': {
                'columns': {
                    ...
                    'type': 'list',
                    'options': {
                        'index': {'v_range': [['7.4.3', '']], 'type': 'int'},
                        'optional': {'v_range': [['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                        'type': {'v_range': [['7.4.3', '']], 'type': 'list', 'elements': 'str'}
                    },
                    'elements': 'dict'
                },
                'data': {'v_range': [['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                'name': {'v_range': [['7.4.3', '']], 'required': True, 'type': 'str'},
                'optional': {'v_range': [['7.4.3', '']], 'type': 'int'}
            }
        }
    }
