...
DOCUMENTATION = '''
---
module: fmgd_azure_vwanslb_temporarysecurityrules_rules
short_description: Configure security rules.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure security rules.
      fortinet.fmgdevice.fmgd_azure_vwanslb_temporarysecurityrules_rules:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'azure_vwanslb_temporarysecurityrules_rules'),
