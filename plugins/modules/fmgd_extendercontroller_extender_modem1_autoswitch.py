...
DOCUMENTATION = '''
---
module: fmgd_extendercontroller_extender_modem1_autoswitch
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: FortiExtender auto switch configuration.
      fortinet.fmgdevice.fmgd_extendercontroller_extender_modem1_autoswitch:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'extendercontroller_extender_modem1_autoswitch'),
