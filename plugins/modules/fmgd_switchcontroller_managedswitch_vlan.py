...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_managedswitch_vlan
short_description: Configure VLAN assignment priority.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure VLAN assignment priority.
      fortinet.fmgdevice.fmgd_switchcontroller_managedswitch_vlan:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_managedswitch_vlan'),
