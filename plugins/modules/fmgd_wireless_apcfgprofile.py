...
DOCUMENTATION = '''
---
module: fmgd_wireless_apcfgprofile
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure AP local configuration profiles.
      fortinet.fmgdevice.fmgd_wireless_apcfgprofile:
...
def main():
    ...
    module_arg_spec = {
        ...
        'wireless_apcfgprofile': {
            ...
            'options': {
                'ac-ip': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'ac-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'ac-timer': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'ac-type': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['default', 'specify', 'apcfg'], 'type': 'str'},
                'ap-family': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['fap', 'fap-u', 'fap-c'], 'type': 'str'},
                'command-list': {
                    'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']],
                    'type': 'list',
                    'options': {
                        ...
                        'passwd-value': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'no_log': True, 'type': 'list', 'elements': 'str'},
                        'type': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['non-password', 'password'], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_apcfgprofile'),
