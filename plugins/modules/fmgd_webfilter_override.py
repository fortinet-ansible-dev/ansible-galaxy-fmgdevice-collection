...
DOCUMENTATION = '''
---
module: fmgd_webfilter_override
...
options:
    ...
    webfilter_override:
        ...
        suboptions:
            expires:
                type: str
                description: Override expiration date and time, from 5 minutes to 365 from now
            id:
                type: int
            ...
            initiator:
                type: str
                description: Initiating user of override
            ip:
                type: str
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure FortiGuard Web Filter administrative overrides.
      fortinet.fmgdevice.fmgd_webfilter_override:
        ...
        webfilter_override:
          ...
          # ip: <string>
          # ip6: <string>
          # new_profile: <list or string>
          # old_profile: <list or string>
          # scope: <value in [user, user-group, ip, ...]>
...
def main():
    ...
    module_arg_spec = {
        ...
        'webfilter_override': {
            ...
            'options': {
                'expires': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'id': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'required': True, 'type': 'int'},
                'initiator': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'ip': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'ip6': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'new-profile': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                'old-profile': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                'scope': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['user', 'user-group', 'ip', 'ip6'], 'type': 'str'},
                'status': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'user': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'webfilter_override'),
