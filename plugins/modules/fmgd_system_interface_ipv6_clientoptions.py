...
DOCUMENTATION = '''
---
module: fmgd_system_interface_ipv6_clientoptions
short_description: DHCP6 client options.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: DHCP6 client options.
      fortinet.fmgdevice.fmgd_system_interface_ipv6_clientoptions:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_interface_ipv6_clientoptions'),
