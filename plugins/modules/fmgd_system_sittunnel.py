...
DOCUMENTATION = '''
---
module: fmgd_system_sittunnel
short_description: Configure IPv6 tunnel over IPv4.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure IPv6 tunnel over IPv4.
      fortinet.fmgdevice.fmgd_system_sittunnel:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_sittunnel'),
