...
DOCUMENTATION = '''
---
module: fmgd_firewall_dnstranslation
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure DNS translation.
      fortinet.fmgdevice.fmgd_firewall_dnstranslation:
...
def main():
    ...
    module_arg_spec = {
        ...
        'firewall_dnstranslation': {
            ...
            'options': {
                ...
                'netmask': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_dnstranslation'),
