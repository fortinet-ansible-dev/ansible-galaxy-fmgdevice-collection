...
DOCUMENTATION = '''
---
module: fmgd_system_fssopolling
    ...
    system_fssopolling:
        ...
        suboptions:
            ...
            listening_port:
                ...
                type: int
                description: Listening port to accept clients
            status:
                type: str
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure Fortinet Single Sign On
      fortinet.fmgdevice.fmgd_system_fssopolling:
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_fssopolling': {
            ...
            'options': {
                '_gui_meta': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'auth-password': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'no_log': True, 'type': 'list', 'elements': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_fssopolling'),
