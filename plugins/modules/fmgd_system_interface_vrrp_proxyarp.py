...
DOCUMENTATION = '''
---
module: fmgd_system_interface_vrrp_proxyarp
short_description: VRRP Proxy ARP configuration.
description:
...
options:
    ...
    interface:
        ...
        required: true
    vrrp:
        description: The parameter (vrrp) in requested url.
        type: str
        required: true
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: VRRP Proxy ARP configuration.
      fortinet.fmgdevice.fmgd_system_interface_vrrp_proxyarp:
...
def main():
    ...
    url_params = ['device', 'interface', 'vrrp']
    module_primary_key = 'id'
    module_arg_spec = {
        'device': {'required': True, 'type': 'str'},
        'interface': {'required': True, 'type': 'str'},
        'vrrp': {'required': True, 'type': 'str'},
        'system_interface_vrrp_proxyarp': {
            'type': 'dict',
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_interface_vrrp_proxyarp'),
