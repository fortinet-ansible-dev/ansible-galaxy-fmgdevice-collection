...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_h2qpadviceofcharge
short_description: Configure advice of charge.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure advice of charge.
      fortinet.fmgdevice.fmgd_wireless_hotspot20_h2qpadviceofcharge:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_h2qpadviceofcharge'),
