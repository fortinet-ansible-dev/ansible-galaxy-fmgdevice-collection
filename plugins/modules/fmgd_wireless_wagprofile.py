...
DOCUMENTATION = '''
---
module: fmgd_wireless_wagprofile
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure wireless access gateway
      fortinet.fmgdevice.fmgd_wireless_wagprofile:
...
def main():
    ...
    module_arg_spec = {
        ...
        'wireless_wagprofile': {
            ...
            'options': {
                ...
                'dhcp-ip-addr': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'name': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'required': True, 'type': 'str'},
                'ping-interval': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'ping-number': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'return-packet-timeout': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'tunnel-type': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['gre', 'l2tpv3'], 'type': 'str'},
                'wag-ip': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'wag-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_wagprofile'),
