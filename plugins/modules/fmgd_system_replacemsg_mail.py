...
DOCUMENTATION = '''
---
module: fmgd_system_replacemsg_mail
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Replacement messages.
      fortinet.fmgdevice.fmgd_system_replacemsg_mail:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_replacemsg_mail'),
