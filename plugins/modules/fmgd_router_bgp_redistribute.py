...
DOCUMENTATION = '''
---
module: fmgd_router_bgp_redistribute
short_description: BGP IPv4 redistribute table.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: BGP IPv4 redistribute table.
      fortinet.fmgdevice.fmgd_router_bgp_redistribute:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_bgp_redistribute'),
