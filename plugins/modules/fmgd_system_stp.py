    ...
    system_stp:
        ...
        suboptions:
            ...
            max_age:
                aliases: ['max-age']
                type: int
                description: Maximum packet age
            max_hops:
                aliases: ['max-hops']
                type: int
                description: Maximum number of hops
            switch_priority:
                aliases: ['switch-priority']
                type: str
                description: STP switch priority; the lower the number the higher the priority
                choices:
                    - '0'
                    - '4096'
                    - '8192'
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure Spanning Tree Protocol
      fortinet.fmgdevice.fmgd_system_stp:
        ...
        system_stp:
          ...
          # max_age: <integer>
          # max_hops: <integer>
          # switch_priority: <value in [0, 4096, 8192, ...]>
'''
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_stp': {
            ...
            'options': {
                'forward-delay': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_stp'),
