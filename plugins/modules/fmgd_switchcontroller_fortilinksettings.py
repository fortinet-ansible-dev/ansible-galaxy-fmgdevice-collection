...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_fortilinksettings
    ...
    - name: Configure integrated FortiLink settings for FortiSwitch.
      fortinet.fmgdevice.fmgd_switchcontroller_fortilinksettings:
        ...
        switchcontroller_fortilinksettings:
          ...
          #   nac_lan_interface: <list or string>
...
def main():
    ...
    module_arg_spec = {
        ...
        'switchcontroller_fortilinksettings': {
            ...
            'options': {
                'access-vlan-mode': {'v_range': [['7.4.3', '']], 'choices': ['legacy', 'fail-open', 'fail-close'], 'type': 'str'},
                ...
                'nac-ports': {
                    ...
                    'type': 'dict',
                    'options': {
                        'lan-segment': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disabled', 'enabled'], 'type': 'str'},
                        'member-change': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                        'nac-lan-interface': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                        'nac-segment-vlans': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
