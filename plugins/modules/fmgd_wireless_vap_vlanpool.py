...
DOCUMENTATION = '''
---
module: fmgd_wireless_vap_vlanpool
short_description: VLAN pool.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: VLAN pool.
      fortinet.fmgdevice.fmgd_wireless_vap_vlanpool:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_vap_vlanpool'),
