...
DOCUMENTATION = '''
---
module: fmgd_router_multicastflow
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure multicast-flow.
      fortinet.fmgdevice.fmgd_router_multicastflow:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_multicastflow'),
