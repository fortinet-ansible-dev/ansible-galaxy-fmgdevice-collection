...
DOCUMENTATION = '''
---
module: fmgd_wireless_arrpprofile
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure WiFi Automatic Radio Resource Provisioning
      fortinet.fmgdevice.fmgd_wireless_arrpprofile:
        ...
        wireless_arrpprofile:
          ...
          # include_dfs_channel: <value in [disable, enable, no, ...]>
          # include_weather_channel: <value in [disable, enable, no, ...]>
...
def main():
    ...
    module_arg_spec = {
        ...
        'wireless_arrpprofile': {
            ...
            'options': {
                ...
                'include-dfs-channel': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable', 'no', 'yes'], 'type': 'str'},
                'include-weather-channel': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable', 'no', 'yes'], 'type': 'str'},
                'monitor-period': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'name': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'required': True, 'type': 'str'},
                'override-darrp-optimize': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'selection-period': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'threshold-ap': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'threshold-channel-load': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'threshold-noise-floor': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'threshold-rx-errors': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'threshold-spectral-rssi': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'threshold-tx-retries': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'weight-channel-load': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'weight-dfs-channel': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'weight-managed-ap': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'weight-noise-floor': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'weight-rogue-ap': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'weight-spectral-rssi': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'weight-weather-channel': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_arrpprofile'),
