    ...
    system_apiuser:
        ...
        suboptions:
            ...
            cors_allow_origin:
                ...
                type: str
                description: Value for Access-Control-Allow-Origin on API responses.
            name:
                type: str
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure API users.
      fortinet.fmgdevice.fmgd_system_apiuser:
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_apiuser': {
            ...
            'options': {
                ...
                'api-key': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'no_log': True, 'type': 'list', 'elements': 'str'},
                'comments': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'cors-allow-origin': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_apiuser'),
