...
DOCUMENTATION = '''
---
module: fmgd_ztna_webproxy
short_description: Configure ZTNA web-proxy.
description:
    ...
    ztna_webproxy:
        ...
        suboptions:
            ...
            svr_pool_server_max_concurrent_request:
                ...
                type: int
                description: Maximum number of concurrent requests that servers in the server pool could handle
            svr_pool_server_max_request:
                aliases: ['svr-pool-server-max-request']
                type: int
                description: Maximum number of requests that servers in the server pool handle before disconnecting
            svr_pool_ttl:
...
def main():
    ...
    module_arg_spec = {
        ...
        'ztna_webproxy': {
            ...
            'options': {
                ...
                'svr-pool-multiplex': {'v_range': [['7.6.2', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'svr-pool-server-max-concurrent-request': {'v_range': [['7.6.2', '']], 'type': 'int'},
                'svr-pool-server-max-request': {'v_range': [['7.6.2', '']], 'type': 'int'},
                'svr-pool-ttl': {'v_range': [['7.6.2', '']], 'type': 'int'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'ztna_webproxy'),
