...
DOCUMENTATION = '''
---
module: fmgd_wireless_vap_portalmessageoverrides
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Individual message overrides.
      fortinet.fmgdevice.fmgd_wireless_vap_portalmessageoverrides:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_vap_portalmessageoverrides'),
