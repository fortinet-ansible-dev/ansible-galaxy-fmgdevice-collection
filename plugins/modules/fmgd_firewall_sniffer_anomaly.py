...
DOCUMENTATION = '''
---
module: fmgd_firewall_sniffer_anomaly
short_description: Configuration method to edit Denial of Service
description:
...
options:
    ...
    vdom:
        ...
        required: true
    sniffer:
        description: The parameter (sniffer) in requested url.
        type: str
        required: true
...
def main():
    ...
    url_params = ['device', 'vdom', 'sniffer']
    module_primary_key = 'name'
    module_arg_spec = {
        'device': {'required': True, 'type': 'str'},
        'vdom': {'required': True, 'type': 'str'},
        'sniffer': {'required': True, 'type': 'str'},
        'firewall_sniffer_anomaly': {
            'type': 'dict',
            ...
            'options': {
                ...
                'quarantine': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['none', 'attacker', 'both', 'interface'], 'type': 'str'},
                ...
                'synproxy-tcp-window': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['4096', '8192', '16384', '32768'], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_sniffer_anomaly'),
