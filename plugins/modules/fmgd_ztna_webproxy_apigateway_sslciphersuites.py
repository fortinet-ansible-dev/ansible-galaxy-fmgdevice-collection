...
DOCUMENTATION = '''
---
module: fmgd_ztna_webproxy_apigateway_sslciphersuites
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: SSL/TLS cipher suites to offer to a server, ordered by priority.
      fortinet.fmgdevice.fmgd_ztna_webproxy_apigateway_sslciphersuites:
...
def main():
    ...
    url_params = ['device', 'vdom', 'web-proxy', 'api-gateway']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'ztna_webproxy_apigateway_sslciphersuites'),
