...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_location_coordinates
short_description: Configure location GPS coordinates.
description:
...
options:
    ...
    vdom:
        ...
        required: true
    location:
        description: The parameter (location) in requested url.
        type: str
        required: true
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure location GPS coordinates.
      fortinet.fmgdevice.fmgd_switchcontroller_location_coordinates:
...
def main():
    ...
    url_params = ['device', 'vdom', 'location']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_location_coordinates'),
