...
DOCUMENTATION = '''
---
module: fmgd_system_5gmodem_modem1_simswitch
short_description: Configure SIM card switch.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure SIM card switch.
      fortinet.fmgdevice.fmgd_system_5gmodem_modem1_simswitch:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_5gmodem_modem1_simswitch'),
