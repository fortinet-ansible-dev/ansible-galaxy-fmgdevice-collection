...
DOCUMENTATION = '''
---
module: fmgd_system_vnetunnel
short_description: Configure virtual network enabler tunnel.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure virtual network enabler tunnel.
      fortinet.fmgdevice.fmgd_system_vnetunnel:
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_vnetunnel': {
            ...
            'options': {
                ...
                'bmr-hostname': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                'br': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'http-password': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'no_log': True, 'type': 'list', 'elements': 'str'},
                'http-username': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'interface': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                'ipv4-address': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                'mode': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['map-e', 'fixed-ip', 'ds-lite'], 'type': 'str'},
                ...
                'update-url': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_vnetunnel'),
