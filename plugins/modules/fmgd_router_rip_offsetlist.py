...
DOCUMENTATION = '''
---
module: fmgd_router_rip_offsetlist
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Offset list.
      fortinet.fmgdevice.fmgd_router_rip_offsetlist:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_rip_offsetlist'),
