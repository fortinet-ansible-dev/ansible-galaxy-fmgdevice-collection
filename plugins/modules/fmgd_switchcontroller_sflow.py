...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_sflow
short_description: Configure FortiSwitch sFlow.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure FortiSwitch sFlow.
      fortinet.fmgdevice.fmgd_switchcontroller_sflow:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_sflow'),
