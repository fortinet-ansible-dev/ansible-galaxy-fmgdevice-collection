...
DOCUMENTATION = '''
---
module: fmgd_router_ospf_distributelist
short_description: Distribute list configuration.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Distribute list configuration.
      fortinet.fmgdevice.fmgd_router_ospf_distributelist:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_ospf_distributelist'),
