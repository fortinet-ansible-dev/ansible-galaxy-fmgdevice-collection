...
DOCUMENTATION = '''
---
module: fmgd_log_webtrends_setting
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Settings for WebTrends.
      fortinet.fmgdevice.fmgd_log_webtrends_setting:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'log_webtrends_setting'),
