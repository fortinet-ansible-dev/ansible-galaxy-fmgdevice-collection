...
DOCUMENTATION = '''
---
module: fmgd_router_multicast_pimsmglobal_rpaddress
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Statically configure RP addresses.
      fortinet.fmgdevice.fmgd_router_multicast_pimsmglobal_rpaddress:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_multicast_pimsmglobal_rpaddress'),
