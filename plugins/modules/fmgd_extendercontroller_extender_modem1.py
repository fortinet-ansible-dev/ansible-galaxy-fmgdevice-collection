...
DOCUMENTATION = '''
---
module: fmgd_extendercontroller_extender_modem1
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configuration options for modem 1.
      fortinet.fmgdevice.fmgd_extendercontroller_extender_modem1:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'extendercontroller_extender_modem1'),
