...
DOCUMENTATION = '''
---
module: fmgd_router_ospf_summaryaddress
short_description: IP address summary configuration.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: IP address summary configuration.
      fortinet.fmgdevice.fmgd_router_ospf_summaryaddress:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_ospf_summaryaddress'),
