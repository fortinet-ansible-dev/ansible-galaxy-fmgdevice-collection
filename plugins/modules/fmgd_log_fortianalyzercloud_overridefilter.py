...
DOCUMENTATION = '''
---
module: fmgd_log_fortianalyzercloud_overridefilter
short_description: Override filters for FortiAnalyzer Cloud.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Override filters for FortiAnalyzer Cloud.
      fortinet.fmgdevice.fmgd_log_fortianalyzercloud_overridefilter:
...
def main():
    ...
    module_arg_spec = {
        ...
        'log_fortianalyzercloud_overridefilter': {
            ...
            'options': {
                ...
                'dlp-archive': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'log_fortianalyzercloud_overridefilter'),
