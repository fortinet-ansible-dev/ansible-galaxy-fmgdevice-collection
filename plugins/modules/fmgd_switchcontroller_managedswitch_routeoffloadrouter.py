...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_managedswitch_routeoffloadrouter
short_description: Configure route offload MCLAG IP address.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure route offload MCLAG IP address.
      fortinet.fmgdevice.fmgd_switchcontroller_managedswitch_routeoffloadrouter:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_managedswitch_routeoffloadrouter'),
