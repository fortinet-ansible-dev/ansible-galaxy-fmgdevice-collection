...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure L2TP.
      fortinet.fmgdevice.fmgd_vpn_l2tp:
        ...
        vdom: <your own value>
        vpn_l2tp:
          # compress: <value in [disable, enable]>
          # eip: <string>
          # enforce_ipsec: <value in [disable, enable]>
...
def main():
    ...
    module_arg_spec = {
        ...
        'vpn_l2tp': {
            ...
            'options': {
                'compress': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'eip': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'enforce-ipsec': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                ...
                'sip': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'vpn_l2tp'),
