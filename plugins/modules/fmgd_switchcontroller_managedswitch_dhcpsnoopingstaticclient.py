...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_managedswitch_dhcpsnoopingstaticclient
short_description: Configure FortiSwitch DHCP snooping static clients.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure FortiSwitch DHCP snooping static clients.
      fortinet.fmgdevice.fmgd_switchcontroller_managedswitch_dhcpsnoopingstaticclient:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_managedswitch_dhcpsnoopingstaticclient'),
