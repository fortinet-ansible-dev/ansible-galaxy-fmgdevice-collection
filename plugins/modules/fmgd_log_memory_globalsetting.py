...
DOCUMENTATION = '''
---
module: fmgd_log_memory_globalsetting
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Global settings for memory logging.
      fortinet.fmgdevice.fmgd_log_memory_globalsetting:
...
def main():
    ...
    module_arg_spec = {
        ...
        'log_memory_globalsetting': {
            ...
            'options': {
                ...
                'max-size': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'log_memory_globalsetting'),
