...
DOCUMENTATION = '''
---
module: fmgd_router_bgp_network
short_description: BGP network table.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: BGP network table.
      fortinet.fmgdevice.fmgd_router_bgp_network:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_bgp_network'),
