...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_acl_ingress_action
short_description: ACL actions.
description:
...
def main():
    ...
    url_params = ['device', 'vdom', 'ingress']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_acl_ingress_action'),
