...
DOCUMENTATION = '''
---
module: fmgd_gtp_ieallowlist_entries
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Entries of allow list for unknown or out-of-state IEs.
      fortinet.fmgdevice.fmgd_gtp_ieallowlist_entries:
...
def main():
    ...
    url_params = ['device', 'vdom', 'ie-allow-list']
    ...
    module_arg_spec = {
        ...
        'gtp_ieallowlist_entries': {
            ...
            'options': {
                'id': {'v_range': [['7.2.6', '7.2.8'], ['7.4.3', '7.6.1']], 'required': True, 'type': 'int'},
                'ie': {'v_range': [['7.2.6', '7.2.8'], ['7.4.3', '7.6.1']], 'type': 'int'},
                'fmgr_message': {'v_range': [['7.2.6', '7.2.8'], ['7.4.3', '7.6.1']], 'type': 'int'}
            }
        }
    }
