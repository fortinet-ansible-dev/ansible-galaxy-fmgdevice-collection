...
DOCUMENTATION = '''
---
module: fmgd_system_5gmodem_dataplan
short_description: Configure data plan.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure data plan.
      fortinet.fmgdevice.fmgd_system_5gmodem_dataplan:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_5gmodem_dataplan'),
