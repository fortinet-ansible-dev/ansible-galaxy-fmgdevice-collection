...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_remotelog
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure logging by FortiSwitch device to a remote syslog server.
      fortinet.fmgdevice.fmgd_switchcontroller_remotelog:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_remotelog'),
