...
DOCUMENTATION = '''
---
module: fmgd_report_layout_page_header
short_description: Configure report page header.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure report page header.
      fortinet.fmgdevice.fmgd_report_layout_page_header:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'report_layout_page_header'),
