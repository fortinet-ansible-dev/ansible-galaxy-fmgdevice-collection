...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_trafficsniffer_targetmac
short_description: Sniffer MACs to filter.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Sniffer MACs to filter.
      fortinet.fmgdevice.fmgd_switchcontroller_trafficsniffer_targetmac:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_trafficsniffer_targetmac'),
