...
DOCUMENTATION = '''
---
module: fmgd_router_ripng_aggregateaddress
short_description: Aggregate address.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Aggregate address.
      fortinet.fmgdevice.fmgd_router_ripng_aggregateaddress:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_ripng_aggregateaddress'),
