...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_managedswitch_ports_dhcpsnoopoption82override
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure DHCP snooping option 82 override.
      fortinet.fmgdevice.fmgd_switchcontroller_managedswitch_ports_dhcpsnoopoption82override:
...
def main():
    ...
    url_params = ['device', 'vdom', 'managed-switch', 'ports']
