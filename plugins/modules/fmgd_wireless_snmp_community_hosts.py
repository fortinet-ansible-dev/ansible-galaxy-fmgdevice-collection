...
DOCUMENTATION = '''
---
module: fmgd_wireless_snmp_community_hosts
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure IPv4 SNMP managers
      fortinet.fmgdevice.fmgd_wireless_snmp_community_hosts:
...
def main():
    ...
    url_params = ['device', 'vdom', 'community']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_snmp_community_hosts'),
