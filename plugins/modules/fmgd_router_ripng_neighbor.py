...
DOCUMENTATION = '''
---
module: fmgd_router_ripng_neighbor
short_description: Neighbor.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Neighbor.
      fortinet.fmgdevice.fmgd_router_ripng_neighbor:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_ripng_neighbor'),
