...
DOCUMENTATION = '''
---
module: fmgd_router_bfd_multihoptemplate
short_description: BFD multi-hop template table.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: BFD multi-hop template table.
      fortinet.fmgdevice.fmgd_router_bfd_multihoptemplate:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_bfd_multihoptemplate'),
