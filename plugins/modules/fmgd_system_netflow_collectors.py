...
DOCUMENTATION = '''
---
module: fmgd_system_netflow_collectors
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Netflow collectors.
      fortinet.fmgdevice.fmgd_system_netflow_collectors:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_netflow_collectors'),
