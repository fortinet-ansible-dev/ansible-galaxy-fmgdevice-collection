...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure debug URL addresses.
      fortinet.fmgdevice.fmgd_webproxy_debugurl:
...
def main():
    ...
    module_arg_spec = {
        ...
        'webproxy_debugurl': {
            ...
            'options': {
                'exact': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'webproxy_debugurl'),
