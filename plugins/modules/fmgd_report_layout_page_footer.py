...
DOCUMENTATION = '''
---
module: fmgd_report_layout_page_footer
short_description: Configure report page footer.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure report page footer.
      fortinet.fmgdevice.fmgd_report_layout_page_footer:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'report_layout_page_footer'),
