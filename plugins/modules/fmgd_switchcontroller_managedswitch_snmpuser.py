...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_managedswitch_snmpuser
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configuration method to edit Simple Network Management Protocol
      fortinet.fmgdevice.fmgd_switchcontroller_managedswitch_snmpuser:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_managedswitch_snmpuser'),
