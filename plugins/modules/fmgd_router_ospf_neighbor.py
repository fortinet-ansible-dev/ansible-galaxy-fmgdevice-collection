...
DOCUMENTATION = '''
---
module: fmgd_router_ospf_neighbor
short_description: OSPF neighbor configuration are used when OSPF runs on non-broadcast media.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: OSPF neighbor configuration are used when OSPF runs on non-broadcast media.
      fortinet.fmgdevice.fmgd_router_ospf_neighbor:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_ospf_neighbor'),
