...
DOCUMENTATION = '''
---
module: fmgd_router_bgp_vrf_leaktarget
...
options:
    ...
    vdom:
        ...
        required: true
    vrf:
        description: The parameter (vrf) in requested url.
        type: str
        required: true
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Target VRF table.
      fortinet.fmgdevice.fmgd_router_bgp_vrf_leaktarget:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_bgp_vrf_leaktarget'),
