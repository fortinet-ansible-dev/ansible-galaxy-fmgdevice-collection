...
DOCUMENTATION = '''
---
module: fmgd_system_speedtestserver
short_description: Configure speed test server list.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure speed test server list.
      fortinet.fmgdevice.fmgd_system_speedtestserver:
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_speedtestserver': {
            ...
            'options': {
                ...
                'timestamp': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_speedtestserver'),
