...
DOCUMENTATION = '''
---
module: fmgd_system_vdomradiusserver
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure a RADIUS server to use as a RADIUS Single Sign On
      fortinet.fmgdevice.fmgd_system_vdomradiusserver:
        ...
        system_vdomradiusserver:
          ...
          # radius_server_vdom: <list or string>
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_vdomradiusserver': {
            ...
            'options': {
                ...
                'radius-server-vdom': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_vdomradiusserver'),
