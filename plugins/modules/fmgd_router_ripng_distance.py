...
DOCUMENTATION = '''
---
module: fmgd_router_ripng_distance
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Distance.
      fortinet.fmgdevice.fmgd_router_ripng_distance:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_ripng_distance'),
