...
DOCUMENTATION = '''
---
module: fmgd_wireless_wtpprofile_splittunnelingacl
short_description: Split tunneling ACL filter list.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Split tunneling ACL filter list.
      fortinet.fmgdevice.fmgd_wireless_wtpprofile_splittunnelingacl:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_wtpprofile_splittunnelingacl'),
