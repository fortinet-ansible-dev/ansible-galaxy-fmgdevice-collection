...
DOCUMENTATION = '''
---
module: fmgd_system_dscpbasedpriority
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure DSCP based priority table.
      fortinet.fmgdevice.fmgd_system_dscpbasedpriority:
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_dscpbasedpriority': {
            ...
            'options': {
                'ds': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_dscpbasedpriority'),
