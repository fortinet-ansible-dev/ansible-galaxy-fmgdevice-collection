...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_h2qposuprovidernai
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure online sign up
      fortinet.fmgdevice.fmgd_wireless_hotspot20_h2qposuprovidernai:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_h2qposuprovidernai'),
