...
DOCUMENTATION = '''
---
module: fmgd_system_emailserver
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure the email server used by the FortiGate various things.
      fortinet.fmgdevice.fmgd_system_emailserver:
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_emailserver': {
            ...
            'options': {
                'authenticate': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                ...
                'reply-to': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'security': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['none', 'starttls', 'smtps'], 'type': 'str'},
                ...
                'type': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['custom'], 'type': 'str'},
                'username': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'validate-server': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_emailserver'),
