...
DOCUMENTATION = '''
---
module: fmgd_system_sdwan_healthcheckfortiguard_sla
...
def main():
    ...
    url_params = ['device', 'vdom', 'health-check-fortiguard']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_sdwan_healthcheckfortiguard_sla'),
