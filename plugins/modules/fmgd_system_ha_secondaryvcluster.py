...
DOCUMENTATION = '''
---
module: fmgd_system_ha_secondaryvcluster
short_description: Configure virtual cluster 2.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure virtual cluster 2.
      fortinet.fmgdevice.fmgd_system_ha_secondaryvcluster:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_ha_secondaryvcluster'),
