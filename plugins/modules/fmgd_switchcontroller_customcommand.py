...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_customcommand
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure the FortiGate switch controller to send custom commands to managed FortiSwitch devices.
      fortinet.fmgdevice.fmgd_switchcontroller_customcommand:
...
def main():
    ...
    module_primary_key = 'command_name'
    module_arg_spec = {
        ...
        'switchcontroller_customcommand': {
            ...
            'options': {
                'command': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'command-name': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_customcommand'),
