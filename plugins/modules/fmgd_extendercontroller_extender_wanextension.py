...
DOCUMENTATION = '''
---
module: fmgd_extendercontroller_extender_wanextension
short_description: Device vdom extender controller extender wan extension
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Device vdom extender controller extender wan extension
      fortinet.fmgdevice.fmgd_extendercontroller_extender_wanextension:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'extendercontroller_extender_wanextension'),
