...
DOCUMENTATION = '''
---
module: fmgd_wireless_ssidpolicy
short_description: Configure WiFi SSID policies.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure WiFi SSID policies.
      fortinet.fmgdevice.fmgd_wireless_ssidpolicy:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_ssidpolicy'),
