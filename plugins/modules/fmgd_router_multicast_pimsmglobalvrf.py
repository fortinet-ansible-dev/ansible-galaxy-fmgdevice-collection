...
DOCUMENTATION = '''
---
module: fmgd_router_multicast_pimsmglobalvrf
short_description: per-VRF PIM sparse-mode global settings.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Per-VRF PIM sparse-mode global settings.
      fortinet.fmgdevice.fmgd_router_multicast_pimsmglobalvrf:
...
def main():
    ...
    module_arg_spec = {
        ...
        'router_multicast_pimsmglobalvrf': {
            ...
            'options': {
                ...
                'vrf': {'v_range': [['7.6.2', '']], 'required': True, 'type': 'int'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_multicast_pimsmglobalvrf'),
