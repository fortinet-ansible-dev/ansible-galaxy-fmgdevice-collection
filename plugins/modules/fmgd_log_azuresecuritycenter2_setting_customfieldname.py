...
DOCUMENTATION = '''
---
module: fmgd_log_azuresecuritycenter2_setting_customfieldname
short_description: Custom field name for CEF format logging.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Custom field name for CEF format logging.
      fortinet.fmgdevice.fmgd_log_azuresecuritycenter2_setting_customfieldname:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'log_azuresecuritycenter2_setting_customfieldname'),
