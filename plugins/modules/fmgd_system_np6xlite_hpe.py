...
DOCUMENTATION = '''
---
module: fmgd_system_np6xlite_hpe
...
options:
    ...
    device:
        ...
        required: true
    np6xlite:
        description: The parameter (np6xlite) in requested url.
        type: str
        required: true
    system_np6xlite_hpe:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: HPE configuration.
      fortinet.fmgdevice.fmgd_system_np6xlite_hpe:
...
def main():
    ...
    url_params = ['device', 'np6xlite']
    module_primary_key = None
    module_arg_spec = {
        'device': {'required': True, 'type': 'str'},
        'np6xlite': {'required': True, 'type': 'str'},
        'system_np6xlite_hpe': {
            'type': 'dict',
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_np6xlite_hpe'),
