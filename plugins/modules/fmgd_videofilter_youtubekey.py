...
DOCUMENTATION = '''
---
module: fmgd_videofilter_youtubekey
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure YouTube API keys.
      fortinet.fmgdevice.fmgd_videofilter_youtubekey:
...
def main():
    ...
    module_arg_spec = {
        ...
        'videofilter_youtubekey': {
            ...
            'v_range': [['7.2.6', '7.2.9']],
            'options': {
                'id': {'v_range': [['7.2.6', '7.2.9']], 'required': True, 'type': 'int'},
                'key': {'v_range': [['7.2.6', '7.2.9']], 'no_log': True, 'type': 'str'},
                'status': {'v_range': [['7.2.6', '7.2.9']], 'choices': ['disable', 'enable'], 'type': 'str'}
            }
        }
    }
