...
DOCUMENTATION = '''
---
module: fmgd_wireless_accesscontrollist
short_description: Configure WiFi bridge access control list.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure WiFi bridge access control list.
      fortinet.fmgdevice.fmgd_wireless_accesscontrollist:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_accesscontrollist'),
