    ...
    system_global:
        ...
        suboptions:
            ...
            admin_scp:
                aliases: ['admin-scp']
                type: str
                description: Enable/disable SCP support for system configuration backup, restore, and firmware file upload.
                choices:
                    - 'disable'
                    - 'enable'
            admin_sport:
            ...
            qsfpdd_split8_port:
                ...
                type: list
                elements: str
                description: Split qsfpddd port
            ...
            switch_controller_reserved_network:
                ...
                type: list
                elements: str
                description: Configure reserved network subnet for managed switches.
            ssd_trim_date:
            ...
            internet_service_download_list:
                ...
                type: list
                elements: str
                description: Configure which on-demand Internet Service IDs are to be downloaded.
            ...
            scim_server_cert:
                ...
                type: list
                elements: str
                description: Server certificate that the FortiGate uses for SCIM connections.
            scim_http_port:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure global attributes.
      fortinet.fmgdevice.fmgd_system_global:
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_global': {
            ...
            'options': {
                'admin-https-redirect': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'admin-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'admin-scp': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'admin-sport': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'admin-ssh-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'admin-ssh-v1': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                ...
                'gui-ipv6': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'gui-theme': {
                    'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']],
                    'choices': [
                ...
                'gui-lines-per-page': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                ...
                'admin-server-cert': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                ...
                'qsfpdd-split8-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                ...
                'switch-controller-reserved-network': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                ...
                'qsfp28-40g-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                ...
                'management-vdom': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                'quic-ack-thresold': {'v_range': [['7.4.3', '']], 'type': 'int'},
                'qsfpdd-100g-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                ...
                'ip-src-port-range': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                ...
                'wifi-ca-certificate': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                ...
                'split-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                ...
                'admin-telnet-port': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                ...
                'ssh-hostkey-password': {'v_range': [['7.4.3', '']], 'no_log': True, 'type': 'list', 'elements': 'str'},
                ...
                'switch-controller': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                ...
                'wifi-certificate': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                ...
                'extender-controller-reserved-network': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                ...
                'internet-service-download-list': {'v_range': [['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                ...
                'admin-forticloud-sso-default-profile': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                ...
                'user-server-cert': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                ...
                'scim-server-cert': {'v_range': [['7.6.0', '']], 'type': 'list', 'elements': 'str'},
