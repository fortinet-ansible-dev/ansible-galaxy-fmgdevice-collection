...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_igmpsnooping
short_description: Configure FortiSwitch IGMP snooping global settings.
description:
    ...
    switchcontroller_igmpsnooping:
        ...
        suboptions:
            aging_time:
                aliases: ['aging-time']
                type: int
                description: Maximum number of seconds to retain a multicast snooping entry for which no packets have been seen
            ...
            query_interval:
                ...
                type: int
                description: Maximum time after which IGMP query will be sent
'''
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure FortiSwitch IGMP snooping global settings.
      fortinet.fmgdevice.fmgd_switchcontroller_igmpsnooping:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_igmpsnooping'),
