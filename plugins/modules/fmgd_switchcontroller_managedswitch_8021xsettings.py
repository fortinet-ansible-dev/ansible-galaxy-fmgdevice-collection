...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_managedswitch_8021xsettings
short_description: Configuration method to edit FortiSwitch 802.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_managedswitch_8021xsettings'),
