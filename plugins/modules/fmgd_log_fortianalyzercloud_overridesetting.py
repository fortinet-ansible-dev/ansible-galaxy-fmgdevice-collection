...
DOCUMENTATION = '''
---
module: fmgd_log_fortianalyzercloud_overridesetting
short_description: Override FortiAnalyzer Cloud settings.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Override FortiAnalyzer Cloud settings.
      fortinet.fmgdevice.fmgd_log_fortianalyzercloud_overridesetting:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'log_fortianalyzercloud_overridesetting'),
