...
DOCUMENTATION = '''
---
module: fmgd_system_zone
short_description: Configure zones to group two or more interfaces.
description:
    ...
    system_zone:
        ...
        suboptions:
            ...
            interface:
                type: list
                elements: str
                description: Add interfaces to this zone.
            intrazone:
                type: str
                description: Allow or deny traffic routing between different interfaces in the same zone
                choices:
                    - 'allow'
                    - 'deny'
            name:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure zones to group two or more interfaces.
      fortinet.fmgdevice.fmgd_system_zone:
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_zone': {
            ...
            'options': {
                ...
                'intrazone': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['allow', 'deny'], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_zone'),
