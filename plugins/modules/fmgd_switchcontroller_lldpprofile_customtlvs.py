...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_lldpprofile_customtlvs
short_description: Configuration method to edit custom TLV entries.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configuration method to edit custom TLV entries.
      fortinet.fmgdevice.fmgd_switchcontroller_lldpprofile_customtlvs:
...
def main():
    ...
    url_params = ['device', 'vdom', 'lldp-profile']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_lldpprofile_customtlvs'),
