...
DOCUMENTATION = '''
---
module: fmgd_log_fortianalyzer_overridefilter
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Override filters for FortiAnalyzer.
      fortinet.fmgdevice.fmgd_log_fortianalyzer_overridefilter:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'log_fortianalyzer_overridefilter'),
