...
DOCUMENTATION = '''
---
module: fmgd_wireless_wtp_splittunnelingacl
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Split tunneling ACL filter list.
      fortinet.fmgdevice.fmgd_wireless_wtp_splittunnelingacl:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_wtp_splittunnelingacl'),
