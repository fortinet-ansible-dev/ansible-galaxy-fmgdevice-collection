...
DOCUMENTATION = '''
---
module: fmgd_wireless_vap_mpskkey
short_description: Device vdom wireless controller vap mpsk key
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Device vdom wireless controller vap mpsk key
      fortinet.fmgdevice.fmgd_wireless_vap_mpskkey:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_vap_mpskkey'),
