...
DOCUMENTATION = '''
---
module: fmgd_system_splitportmode
short_description: Configure split port mode of ports.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure split port mode of ports.
      fortinet.fmgdevice.fmgd_system_splitportmode:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_splitportmode'),
