...
DOCUMENTATION = '''
---
module: fmgd_system_np6xlite
short_description: Configure NP6XLITE attributes.
description:
...
options:
    ...
    system_np6xlite:
        ...
        type: dict
        suboptions:
            congestion_handling_mode:
                aliases: ['congestion-handling-mode']
                type: str
                description: Configure Marvell switch packet congestion handling.
                choices:
                    - 'flow-control'
                    - 'head-of-line'
            fastpath:
                type: str
                description: Enable/disable NP6XLITE offloading
                choices:
                    - 'disable'
                    - 'enable'
            fp_anomaly:
            ...
            hpe:
                ...
                suboptions:
                    ...
                    tcp_others_max:
                        aliases: ['tcp-others-max']
                        type: int
                        description: Maximum TCP packet rate for TCP packets that match none of the 3 types above
                    tcpfin_rst_max:
                    ...
                    tcpsyn_max:
                        aliases: ['tcpsyn-max']
                        type: int
                        description: Maximum TCP SYN only packet rate
                    udp_max:
                        aliases: ['udp-max']
                        type: int
                        description: Maximum UDP packet rate
            ipsec_inner_fragment:
                aliases: ['ipsec-inner-fragment']
                type: str
                description: Enable/disable NP6XLite IPsec fragmentation type
                choices:
                    - 'disable'
                    - 'enable'
            ipsec_sts_timeout:
                ...
                type: str
                description: Set NP6XLite IPsec STS message timeout.
                choices:
                    - '1'
                    - '2'
                    - '3'
            ...
            ipsec_throughput_msg_frequency:
                ...
                type: str
                description: Set NP6XLite IPsec throughput message frequency
                choices:
                    - 'disable'
                    - '32KB'
                    - '32kb'
            ...
            session_timeout_fixed:
                ...
                type: str
                description: Enable/disable fixed timeout interval mode.
                choices:
                    - 'disable'
                    - 'enable'
            session_timeout_interval:
                ...
                type: int
                description: Set session timeout interval
            session_timeout_random_range:
                aliases: ['session-timeout-random-range']
                type: int
                description: Set the randomization range
            asicdos:
                type: str
                description: Enable/disable NP6XLITE DoS offloading.
                choices:
                    - 'disable'
                    - 'enable'
'''
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure NP6XLITE attributes.
      fortinet.fmgdevice.fmgd_system_np6xlite:
        ...
        system_np6xlite:
          ...
          # congestion_handling_mode: <value in [flow-control, head-of-line]>
          ...
          #   sctp_max: <integer>
          #   tcp_max: <integer>
          #   tcp_others_max: <integer>
          #   tcpfin_rst_max: <integer>
          #   tcpsyn_ack_max: <integer>
          #   tcpsyn_max: <integer>
          #   udp_max: <integer>
          # ipsec_inner_fragment: <value in [disable, enable]>
          # ipsec_sts_timeout: <value in [1, 2, 3, ...]>
          # ipsec_throughput_msg_frequency: <value in [disable, 32KB, 32kb, ...]>
          ...
          # asicdos: <value in [disable, enable]>
'''
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_np6xlite': {
            ...
            'options': {
                'congestion-handling-mode': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['flow-control', 'head-of-line'], 'type': 'str'},
                ...
                'hpe': {
                    ...
                    'options': {
                        ...
                        'pri-type-max': {'v_range': [['7.4.3', '']], 'type': 'int'},
                        'sctp-max': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                        'tcp-max': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                        'tcp-others-max': {'v_range': [['7.4.3', '']], 'type': 'int'},
                        'tcpfin-rst-max': {'v_range': [['7.4.3', '']], 'type': 'int'},
                        'tcpsyn-ack-max': {'v_range': [['7.4.3', '']], 'type': 'int'},
                        'tcpsyn-max': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                        'udp-max': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'}
                    }
                },
                'ipsec-inner-fragment': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'},
                'ipsec-sts-timeout': {
                    'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']],
                ...
                'ipsec-throughput-msg-frequency': {
                    'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']],
                    'choices': [
                        'disable', '32KB', '32kb', '64KB', '64kb', '128KB', '128kb', '256KB', '256kb', '512KB', '512kb', '1MB', '1mb', '2MB', '2mb',
                        '4MB', '4mb', '8MB', '8mb', '16MB', '16mb', '32MB', '32mb', '64MB', '64mb', '128MB', '128mb', '256MB', '256mb', '512MB', '512mb',
                        '1GB', '1gb'
                    ],
                    'type': 'str'
                },
                ...
                'asicdos': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disable', 'enable'], 'type': 'str'}
            }
        }
    }
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_np6xlite'),
