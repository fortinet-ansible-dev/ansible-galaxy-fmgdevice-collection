...
DOCUMENTATION = '''
---
module: fmgd_extendercontroller_extender_modem2_autoswitch
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'extendercontroller_extender_modem2_autoswitch'),
