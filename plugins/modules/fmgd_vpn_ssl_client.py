    ...
    vpn_ssl_client:
        ...
        suboptions:
            ...
            peer:
                type: list
                elements: str
                description: Authenticate peers certificate with the peer/peergrp.
            port:
                type: int
                description: SSL-VPN server port.
            priority:
                type: int
                description: Priority for routes added by SSL-VPN
            psk:
                type: list
                elements: str
                description: Pre-shared secret to authenticate with the server
            realm:
                type: str
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Client.
      fortinet.fmgdevice.fmgd_vpn_ssl_client:
        ...
        vpn_ssl_client:
          ...
          # ipv4_subnets: <list or string>
          # ipv6_subnets: <list or string>
          # peer: <list or string>
          # port: <integer>
          # priority: <integer>
          # psk: <list or string>
...
def main():
    ...
    module_arg_spec = {
        ...
        'vpn_ssl_client': {
            ...
            'options': {
                ...
                'ipv4-subnets': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                'ipv6-subnets': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
                ...
                'psk': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'list', 'elements': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'vpn_ssl_client'),
