...
DOCUMENTATION = '''
---
module: fmgd_system_ipsurlfilterdns6
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure IPS URL filter IPv6 DNS servers.
      fortinet.fmgdevice.fmgd_system_ipsurlfilterdns6:
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_ipsurlfilterdns6': {
            ...
            'options': {
                'address6': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_ipsurlfilterdns6'),
