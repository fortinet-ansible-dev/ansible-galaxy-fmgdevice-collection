...
DOCUMENTATION = '''
---
module: fmgd_system_smcntp
short_description: Configure SMC NTP information.
description:
...
options:
    ...
    system_smcntp:
        ...
        suboptions:
            channel:
                type: int
                description: SMC NTP client will send NTP packets through this channel.
            ntpserver:
                type: list
                elements: dict
            ...
            ntpsync:
                type: str
                description: Enable/disable setting the FortiGate SMC system time by synchronizing with an NTP server.
                choices:
                    - 'disable'
                    - 'enable'
            syncinterval:
                type: int
                description: SMC NTP synchronization interval
'''
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure SMC NTP information.
      fortinet.fmgdevice.fmgd_system_smcntp:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_smcntp'),
