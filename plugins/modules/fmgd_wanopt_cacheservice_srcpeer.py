...
DOCUMENTATION = '''
---
module: fmgd_wanopt_cacheservice_srcpeer
short_description: Modify cache-service source peer list.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Modify cache-service source peer list.
      fortinet.fmgdevice.fmgd_wanopt_cacheservice_srcpeer:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wanopt_cacheservice_srcpeer'),
