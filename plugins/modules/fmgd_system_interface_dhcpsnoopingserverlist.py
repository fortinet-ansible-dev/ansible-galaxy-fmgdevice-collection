...
DOCUMENTATION = '''
---
module: fmgd_system_interface_dhcpsnoopingserverlist
short_description: Configure DHCP server access list.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure DHCP server access list.
      fortinet.fmgdevice.fmgd_system_interface_dhcpsnoopingserverlist:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_interface_dhcpsnoopingserverlist'),
