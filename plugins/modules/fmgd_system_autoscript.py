...
options:
    ...
    system_autoscript:
        ...
        suboptions:
            ...
            repeat:
                type: int
                description: Number of times to repeat this script
            script:
                type: str
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure auto script.
      fortinet.fmgdevice.fmgd_system_autoscript:
...
def main():
    ...
    module_arg_spec = {
        ...
        'system_autoscript': {
            ...
            'options': {
                ...
                'repeat': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
                'script': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'start': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['auto', 'manual'], 'type': 'str'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_autoscript'),
