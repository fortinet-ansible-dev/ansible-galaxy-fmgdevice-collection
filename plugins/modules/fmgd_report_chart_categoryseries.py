...
DOCUMENTATION = '''
---
module: fmgd_report_chart_categoryseries
short_description: Category series of pie chart.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Category series of pie chart.
      fortinet.fmgdevice.fmgd_report_chart_categoryseries:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'report_chart_categoryseries'),
