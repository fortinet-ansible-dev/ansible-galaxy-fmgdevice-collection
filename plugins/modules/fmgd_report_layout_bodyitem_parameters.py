...
DOCUMENTATION = '''
---
module: fmgd_report_layout_bodyitem_parameters
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Parameters.
      fortinet.fmgdevice.fmgd_report_layout_bodyitem_parameters:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'report_layout_bodyitem_parameters'),
