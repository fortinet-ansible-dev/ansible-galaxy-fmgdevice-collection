...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_anqpnairealm_nailist_eapmethod_authparam
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: EAP auth param.
      fortinet.fmgdevice.fmgd_wireless_hotspot20_anqpnairealm_nailist_eapmethod_authparam:
...
def main():
    urls_list = [
        '/pm/config/device/{device}/vdom/{vdom}/wireless-controller/hotspot20/anqp-nai-realm/{anqp-nai-realm}/nai-list/{nai-list}/eap-method/{eap-method}/aut'
        'h-param'
    ]
    url_params = ['device', 'vdom', 'anqp-nai-realm', 'nai-list', 'eap-method']
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_anqpnairealm_nailist_eapmethod_authparam'),
