...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_snmpcommunity
short_description: Configure FortiSwitch SNMP v1/v2c communities globally.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure FortiSwitch SNMP v1/v2c communities globally.
      fortinet.fmgdevice.fmgd_switchcontroller_snmpcommunity:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_snmpcommunity'),
