...
DOCUMENTATION = '''
---
module: fmgd_system_vdomnetflow_collectors
short_description: Netflow collectors.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Netflow collectors.
      fortinet.fmgdevice.fmgd_system_vdomnetflow_collectors:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_vdomnetflow_collectors'),
