...
DOCUMENTATION = '''
---
module: fmgd_wireless_wtpprofile_denymaclist
short_description: List of MAC addresses that are denied access to this WTP, FortiAP, or AP.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: List of MAC addresses that are denied access to this WTP, FortiAP, or AP.
      fortinet.fmgdevice.fmgd_wireless_wtpprofile_denymaclist:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_wtpprofile_denymaclist'),
