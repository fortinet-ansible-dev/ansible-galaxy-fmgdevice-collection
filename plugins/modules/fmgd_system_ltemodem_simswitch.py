...
DOCUMENTATION = '''
---
module: fmgd_system_ltemodem_simswitch
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure SIM card switch.
      fortinet.fmgdevice.fmgd_system_ltemodem_simswitch:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_ltemodem_simswitch'),
