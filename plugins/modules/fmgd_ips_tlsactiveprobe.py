...
DOCUMENTATION = '''
---
module: fmgd_ips_tlsactiveprobe
short_description: TLS active probe configuration.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: TLS active probe configuration.
      fortinet.fmgdevice.fmgd_ips_tlsactiveprobe:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'ips_tlsactiveprobe'),
