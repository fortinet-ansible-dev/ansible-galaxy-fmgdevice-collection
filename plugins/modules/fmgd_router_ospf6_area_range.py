...
DOCUMENTATION = '''
---
module: fmgd_router_ospf6_area_range
short_description: OSPF6 area range configuration.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: OSPF6 area range configuration.
      fortinet.fmgdevice.fmgd_router_ospf6_area_range:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_ospf6_area_range'),
