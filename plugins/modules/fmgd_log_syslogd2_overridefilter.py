...
DOCUMENTATION = '''
---
module: fmgd_log_syslogd2_overridefilter
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Override filters for remote system server.
      fortinet.fmgdevice.fmgd_log_syslogd2_overridefilter:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'log_syslogd2_overridefilter'),
