...
DOCUMENTATION = '''
---
module: fmgd_wireless_setting_offendingssid
short_description: Configure offending SSID.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure offending SSID.
      fortinet.fmgdevice.fmgd_wireless_setting_offendingssid:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_setting_offendingssid'),
