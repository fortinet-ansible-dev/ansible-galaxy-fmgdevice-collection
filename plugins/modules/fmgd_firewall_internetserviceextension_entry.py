...
DOCUMENTATION = '''
---
module: fmgd_firewall_internetserviceextension_entry
short_description: Entries added to the Internet Service extension database.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Entries added to the Internet Service extension database.
      fortinet.fmgdevice.fmgd_firewall_internetserviceextension_entry:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_internetserviceextension_entry'),
