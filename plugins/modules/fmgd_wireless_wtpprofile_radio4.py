...
DOCUMENTATION = '''
---
module: fmgd_wireless_wtpprofile_radio4
short_description: Configuration options for radio 4.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configuration options for radio 4.
      fortinet.fmgdevice.fmgd_wireless_wtpprofile_radio4:
...
def main():
    ...
    module_arg_spec = {
        ...
        'wireless_wtpprofile_radio4': {
            ...
            'options': {
                ...
                'mode': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'choices': ['disabled', 'ap', 'monitor', 'sniffer', 'sam'], 'type': 'str'},
                'optional-antenna': {
                    'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']],
                    'choices': [
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_wtpprofile_radio4'),
