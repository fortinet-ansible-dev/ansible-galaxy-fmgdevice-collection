...
DOCUMENTATION = '''
---
module: fmgd_switchcontroller_managedswitch_customcommand
short_description: Configuration method to edit FortiSwitch commands to be pushed to this FortiSwitch device upon rebooting the FortiGate switch contro...
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configuration method to edit FortiSwitch commands to be pushed to this FortiSwitch device upon rebooting the FortiGate switch contro...
      fortinet.fmgdevice.fmgd_switchcontroller_managedswitch_customcommand:
...
def main():
    ...
    module_primary_key = 'command_entry'
    module_arg_spec = {
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'switchcontroller_managedswitch_customcommand'),
