...
DOCUMENTATION = '''
---
module: fmgd_system_autoupdate_pushupdate
...
options:
    ...
    system_autoupdate_pushupdate:
        ...
        suboptions:
            ...
            port:
                type: int
                description: Push update override port.
            status:
                type: str
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure push updates.
      fortinet.fmgdevice.fmgd_system_autoupdate_pushupdate:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_autoupdate_pushupdate'),
