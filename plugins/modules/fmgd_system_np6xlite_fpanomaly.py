...
DOCUMENTATION = '''
---
module: fmgd_system_np6xlite_fpanomaly
short_description: NP6XLITE IPv4 anomaly protection.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_np6xlite_fpanomaly'),
