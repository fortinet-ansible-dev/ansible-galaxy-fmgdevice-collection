...
DOCUMENTATION = '''
---
module: fmgd_router_bgp_vrf6_leaktarget
...
options:
    ...
    vdom:
        ...
        required: true
    vrf6:
        description: The parameter (vrf6) in requested url.
        type: str
        required: true
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Target VRF table.
      fortinet.fmgdevice.fmgd_router_bgp_vrf6_leaktarget:
...
def main():
    ...
    url_params = ['device', 'vdom', 'vrf6']
    module_primary_key = None
    module_arg_spec = {
        'device': {'required': True, 'type': 'str'},
        'vdom': {'required': True, 'type': 'str'},
        'vrf6': {'required': True, 'type': 'str'},
        'router_bgp_vrf6_leaktarget': {
            'type': 'dict',
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_bgp_vrf6_leaktarget'),
