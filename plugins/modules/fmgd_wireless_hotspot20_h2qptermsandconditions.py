...
DOCUMENTATION = '''
---
module: fmgd_wireless_hotspot20_h2qptermsandconditions
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure terms and conditions.
      fortinet.fmgdevice.fmgd_wireless_hotspot20_h2qptermsandconditions:
...
def main():
    ...
    module_arg_spec = {
        ...
        'wireless_hotspot20_h2qptermsandconditions': {
            ...
            'options': {
                'filename': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'str'},
                'name': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'required': True, 'type': 'str'},
                'timestamp': {'v_range': [['7.2.6', '7.2.9'], ['7.4.3', '']], 'type': 'int'},
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_hotspot20_h2qptermsandconditions'),
