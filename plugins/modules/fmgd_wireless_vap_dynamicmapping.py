...
DOCUMENTATION = '''
---
module: fmgd_wireless_vap_dynamicmapping
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Configure Virtual Access Points
      fortinet.fmgdevice.fmgd_wireless_vap_dynamicmapping:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'wireless_vap_dynamicmapping'),
