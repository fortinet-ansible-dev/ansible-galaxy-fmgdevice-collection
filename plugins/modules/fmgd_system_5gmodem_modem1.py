...
DOCUMENTATION = '''
---
module: fmgd_system_5gmodem_modem1
short_description: Configure 5G Modem1.
description:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'system_5gmodem_modem1'),
