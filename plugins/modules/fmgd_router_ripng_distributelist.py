...
DOCUMENTATION = '''
---
module: fmgd_router_ripng_distributelist
short_description: Distribute list.
description:
...
- name: Example playbook (generated based on argument schema)
  ...
  tasks:
    - name: Distribute list.
      fortinet.fmgdevice.fmgd_router_ripng_distributelist:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'router_ripng_distributelist'),
